          ...
          <div className="flex items-center justify-between h-16">
            <motion.div whileTap={{ scale: 0.95 }}>
              <Link href="/" className="flex items-center gap-2 group" aria-label="Deployify Home">
                ...
                <span className="text-xs font-semibold bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)] bg-opacity-50">Deployify</span>
              </Link>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
                <Link href="/api/auth/github">
                  <MovingBorderButton
                    ...
                    className="bg-[var(--foreground)] text-[var(--background)] px-8 py-4 text-xs font-semibold flex items-center justify-center gap-2 rounded-3xl"
                  >
              ...
              <motion.div whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                <Button
                  ...
                  className="w-full text-xs font-semibold h-auto py-4 rounded-xl flex items-center justify-center gap-2 group"
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-6">
                       ...
                       <h3 className="text-xs font-semibold group-hover:text-[var(--primary)] transition-colors">{step.title}</h3>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-xs font-semibold mb-1 text-[var(--muted-foreground)]">Vercel / Netlify</h3>
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-xs font-semibold mb-1 text-[var(--foreground)]">Deployify + GCP</h3>
          ...
          >
            <div className="p-8 rounded-3xl border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm relative group" role="search">
              <h3 className="text-xs font-semibold mb-6 text-center text-[var(--foreground)]">Ready to deploy?</h3>
              <div className="relative">
      ...
      <footer className="relative z-10 border-t border-[var(--border)] py-12 mt-40">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link href="/" className="flex items-center justify-center gap-2 mb-4 group w-fit mx-auto" aria-label="Deployify Home">
            <Rocket className="w-6 h-6 text-[var(--foreground)] group-hover:rotate-12 transition-transform" />
            <span className="text-xs font-semibold">Deployify</span>
          </Link>
