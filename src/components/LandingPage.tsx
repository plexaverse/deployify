            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  ...
                  <X className="w-5 h-5 text-[var(--error)]" aria-label="Not included or premium" />
                </div>
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8">
                  ...
                  <Check className="w-5 h-5 text-[var(--foreground)]" aria-label="Included and optimized" />
                </div>
                <div className="space-y-4">
                  {[
          ...
          >
            <div className="p-8 rounded-3xl border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm relative group" role="search">
              ...
              <div className="relative">
                ...
                <AnimatePresence>
                {searchQuery.trim() && (
                  <motion.div id="repo-results" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 10 }} role="listbox" className="absolute top-full left-0 right-0 mt-2 bg-[var(--card)] border border-[var(--border)] rounded-2xl overflow-hidden z-20 shadow-2xl p-2">
