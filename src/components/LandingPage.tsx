        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2 group" aria-label="Deployify Home">
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)]">Deployify</span>
            </Link>
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 z-[100] p-4 rounded-full bg-[var(--card)] border border-[var(--border)] backdrop-blur-xl text-[var(--foreground)] shadow-lg transition-colors"
