...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] antialiased relative overflow-hidden">
      <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2 group" aria-label="Deployify Home">
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-[var(--gradient-primary)] bg-opacity-50">Deployify</span>
            </Link>
            <div className="flex items-center gap-4">
              ...
              <motion.div whileTap={{ scale: 0.95 }}>
                <Link
                  ...
                  prefetch={false}
                  className="bg-[var(--primary)] text-[var(--primary-foreground)] px-4 py-2 rounded-lg text-sm font-semibold hover:opacity-90 transition-colors flex items-center gap-2"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-extrabold text-center bg-clip-text text-transparent bg-[var(--gradient-primary)] bg-opacity-50 leading-[1.1] tracking-tight mb-6"
            >
            ...
            >
              <motion.div whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                <MovingBorderButton
                  ...
                  className="bg-[var(--primary)] text-[var(--primary-foreground)] px-8 py-4 text-base font-bold flex items-center justify-center gap-2"
                >
              ...
              <motion.button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-xl text-lg font-bold border border-[var(--border)] hover:bg-[var(--card)] transition-all text-center flex items-center justify-center gap-2 group"
                aria-label="Watch 2-minute demo video"
              >
                <div className="relative">
                  <div className="absolute inset-0 bg-[var(--primary)] blur-sm rounded-full opacity-0 group-hover:opacity-50 group-hover:animate-pulse transition-opacity" aria-hidden="true" />
            ...
            >
              ...
              <div className="w-5 h-8 border-2 border-[var(--border)] rounded-full flex justify-center p-1.5">
                <motion.div
                  ...
                  className="w-1 h-1 bg-[var(--foreground)] rounded-full"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="bg-[var(--background)] border border-[var(--border)] px-3 py-2 rounded-xl text-xs font-mono text-[var(--foreground)] font-bold">
                $
              </div>
              ...
              <motion.button
                ...
                className="p-2 hover:bg-[var(--background)] rounded-xl transition-all text-[var(--muted-foreground)] hover:text-[var(--foreground)] active:scale-95"
          ...
          {/* The Method Section */}
          <div className="mt-40">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-24 bg-clip-text text-transparent bg-[var(--gradient-primary)] bg-opacity-50">
                  ...
                  <div key={i} className="mb-20 relative group">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                       <motion.div
                         ...
                         viewport={{ margin: "-100px" }}
                         className="p-3 rounded-2xl bg-[var(--card)] border border-[var(--border)] group-hover:border-[var(--border-hover)] transition-colors shadow-[0_0_15px_rgba(255,255,255,0.05)] group-hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                       >
                         {step.icon}
                       </motion.div>
          ...
          <div className="mt-40">
            <h2 className="text-3xl md:text-5xl font-bold text-center mb-16 bg-clip-text text-transparent bg-[var(--gradient-primary)] bg-opacity-50">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  <div>
                    ...
                    <p className="text-xs text-[var(--muted-foreground)] font-medium">Enterprise DX at a Premium</p>
                  </div>
              ...
              >
                <div className="absolute top-0 right-0 p-4">
                   <div className="bg-[var(--success)] text-[var(--background)] text-[10px] font-black px-2 py-1 rounded-md uppercase tracking-tighter animate-pulse">Save 80%</div>
                </div>
                <div className="flex justify-between items-start mb-8">
                  <div>
          ...
          <div id="features" className="mt-40">
            ...
            <BentoGrid>
              <BentoGridItem
                ...
                header={<div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-[var(--gradient-card)] border border-[var(--border)] items-center justify-center"><Zap className="w-12 h-12 text-[var(--foreground)]" /></div>}
              ...
              <BentoGridItem
                ...
                description={
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <motion.button
                      ...
                      className="p-1.5 rounded-lg hover:bg-[var(--card-hover)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-all active:scale-90"
                ...
                header={<div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-[var(--gradient-card)] border border-[var(--border)] items-center justify-center"><Globe className="w-12 h-12 text-[var(--foreground)]" /></div>}
                icon={<Search className="h-4 w-4 text-[var(--muted-foreground)]" />}
              />
              <BentoGridItem
                title="Cloud Armor WAF"
                description="DDoS protection & security."
                header={<div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-[var(--gradient-card)] border border-[var(--border)] items-center justify-center"><Shield className="w-12 h-12 text-[var(--foreground)]" /></div>}
              ...
              <BentoGridItem
                ...
                header={<div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-[var(--gradient-card)] border border-[var(--border)] items-center justify-center"><Cpu className="w-12 h-12 text-[var(--foreground)]" /></div>}
            ...
            <div className="p-8 rounded-3xl border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm relative group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[var(--background)] border border-[var(--border)] rounded-2xl py-4 pl-12 pr-12 text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/20 transition-all"
                  value={searchQuery}
                ...
                <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-1">
                  {searchQuery ? (
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-[var(--background)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-all active:scale-95"
                    ...
                    os && (
                      <div className="hidden sm:flex items-center gap-1 opacity-50 group-focus-within:opacity-100 transition-opacity">
                        <kbd className="h-5 select-none items-center gap-1 rounded border border-[var(--border)] bg-[var(--background)] px-1.5 font-mono text-[10px] font-bold text-[var(--muted-foreground)]">
                          {os === 'mac' ? '⌘' : 'Ctrl'}
                        </kbd>
                        <kbd className="h-5 select-none items-center gap-1 rounded border border-[var(--border)] bg-[var(--background)] px-1.5 font-mono text-[10px] font-bold text-[var(--muted-foreground)]">
                          K
                  ...
                  <motion.div id="repo-results" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} role="listbox" className="absolute top-full left-0 right-0 mt-2 bg-[var(--card)] border border-[var(--border)] rounded-2xl overflow-hidden z-20 shadow-2xl p-2">
                    {filteredRepos.length > 0 ? filteredRepos.map((repo, i) => (
                      <div
                        ...
                        className={cn("px-4 py-2 rounded-xl cursor-pointer flex items-center gap-3 text-sm transition-colors", selectedIndex === i ? "bg-[var(--background)] text-[var(--foreground)]" : "text-[var(--muted-foreground)] hover:bg-[var(--background)] hover:text-[var(--foreground)]")}
                      >
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-8 bg-clip-text text-transparent bg-[var(--gradient-primary)] bg-opacity-50">
              Global Edge Network
            </h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {[
                ...
                <div key={feat.name} className="group relative p-8 rounded-[2rem] border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm hover:border-[var(--primary)] transition-all duration-500 text-center overflow-hidden">
                  <div className="absolute top-4 right-6 text-xs font-black text-[var(--muted-foreground)]/30 group-hover:text-[var(--foreground)]/20 tabular-nums transition-colors" aria-hidden="true">0{i + 1}</div>
      ...
      <footer className="relative z-10 border-t border-[var(--border)] py-12 mt-40">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link href="/" className="flex items-center justify-center gap-2 mb-4 group w-fit mx-auto" aria-label="Deployify Home">
            <Rocket className="w-6 h-6 text-[var(--foreground)] group-hover:rotate-12 transition-transform" />
            <span className="font-bold text-xl text-[var(--foreground)]">Deployify</span>
          </Link>
