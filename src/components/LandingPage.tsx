          ...
          <div className="flex items-center justify-between h-16">
            <motion.div whileTap={{ scale: 0.95 }}>
              <Link href="/" className="flex items-center gap-2 group" aria-label="Deployify Home">
                ...
                <span className="text-[9px] font-bold bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)] bg-opacity-50">Deployify</span>
              </Link>
            </motion.div>
            <div className="flex items-center gap-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/login" className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors">
                  Sign In
                </Link>
              </motion.div>
              <motion.div whileTap={{ scale: 0.95 }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-[7px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider">
            ...
            <motion.h1
              ...
              className="text-[7px] md:text-[9px] font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)] leading-[1.1] tracking-tight mb-6"
            >
            ...
            <motion.p
              ...
              className="text-[var(--muted-foreground)] text-[7px] md:text-[9px] max-w-2xl mx-auto mb-10"
            >
            ...
            >
              <motion.div whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
                <Link href="/api/auth/github">
                  <MovingBorderButton
                    ...
                    className="bg-[var(--foreground)] text-[var(--background)] px-8 py-4 text-[9px] font-bold flex items-center justify-center gap-2 rounded-3xl"
                  >
              ...
              <motion.div whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                <Button
                  ...
                  className="w-full text-[9px] font-bold h-auto py-4 rounded-xl flex items-center justify-center gap-2 group"
                ...
                >
                  ...
                  Watch Demo
                  <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] ml-1">2 min</span>
                </Button>
              </motion.div>
            </motion.div>
            ...
            <AnimatePresence>
              {showScrollHint && (
                <motion.div
                  ...
                  aria-hidden="true"
                >
                  <span className="text-[7px] uppercase tracking-wider text-[var(--muted-foreground)] font-bold">Scroll to explore</span>
            ...
            >
              <div className="bg-[var(--muted)]/20 px-3 py-2 rounded-xl text-[7px] font-bold uppercase tracking-wider font-mono text-[var(--foreground)]">
                $
              </div>
              <code className="text-[9px] font-mono text-[var(--muted-foreground)] flex-1 text-left">
          ...
          >
            <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] mb-16">
              ...
              >
                {[...['ACME', 'GLOBEX', 'SOYLENT', 'INITECH', 'UMBRELLA', 'CYBERDYNE', 'STARK', 'WAYNE'], ...['ACME', 'GLOBEX', 'SOYLENT', 'INITECH', 'UMBRELLA', 'CYBERDYNE', 'STARK', 'WAYNE']].map((logo, idx) => (
                  <motion.span
                    ...
                    className="text-[7px] font-bold uppercase tracking-wider tracking-wider text-[var(--foreground)] opacity-30 grayscale cursor-default transition-all duration-500"
                  >
                    {logo}
                  </motion.span>
                ))}
          ...
          {/* The Method Section */}
          <div className="mt-40">
            <h2 className="text-[7px] md:text-[9px] font-bold text-center mb-24 bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)]">
                ...
                {[
                  ...
                  >
                    <motion.div
                      ...
                      className="absolute -left-12 md:-left-16 -top-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted)]/20 tabular-nums transition-all group-hover:text-[var(--primary)] group-hover:opacity-100"
                      aria-hidden="true"
                    >
                      0{i + 1}
                    </motion.div>
                    <div className="flex items-center gap-4 mb-6">
                       ...
                       <h3 className="text-[9px] font-bold group-hover:text-[var(--primary)] transition-colors">{step.title}</h3>
                    </div>
                    <div className="text-[9px] text-[var(--muted-foreground)] leading-relaxed mb-6 pl-1">
                      {step.desc}
                    </div>
                    <div className="p-1 rounded-full bg-[var(--primary)]/5 w-fit px-5 py-1.5 text-[7px] font-bold text-[var(--primary)] uppercase tracking-wider border border-[var(--primary)]/10">
                      {step.badge}
                    </div>
                  </motion.div>
                ))}
          ...
          <div className="mt-40">
            <h2 className="text-[7px] md:text-[9px] font-bold text-center mb-16 bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)]">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-[9px] font-bold mb-1 text-[var(--muted-foreground)]">Vercel / Netlify</h3>
                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/70">Enterprise DX at a Premium</p>
                  </div>
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-[9px] font-bold mb-1 text-[var(--foreground)]">Deployify + GCP</h3>
                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Enterprise DX at Raw Cost</p>
                  </div>
          ...
          >
            <div className="p-8 rounded-3xl border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm relative group" role="search">
              <h3 className="text-[9px] font-bold mb-6 text-center text-[var(--foreground)]">Ready to deploy?</h3>
              <div className="relative">
                  ...
                  <AnimatePresence mode="wait">
                    {searchQuery ? (
                      ...
                      os && (
                        ...
                        >
                          <kbd className="h-5 select-none items-center gap-1 rounded border border-[var(--border)] bg-[var(--muted)]/20 px-1.5 font-mono text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                            {os === 'mac' ? '⌘' : 'Ctrl'}
                          </kbd>
                          <kbd className="h-5 select-none items-center gap-1 rounded border border-[var(--border)] bg-[var(--muted)]/20 px-1.5 font-mono text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                            K
                  ...
                  <motion.div id="repo-results" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} role="listbox" className="absolute top-full left-0 right-0 mt-2 bg-[var(--card)] border border-[var(--border)] rounded-2xl overflow-hidden z-20 shadow-2xl p-2">
                    {filteredRepos.length > 0 ? filteredRepos.map((repo, i) => (
                      <div
                        ...
                        className={cn("px-4 py-2 rounded-xl cursor-pointer flex items-center gap-3 text-[7px] font-bold uppercase tracking-wider transition-colors", selectedIndex === i ? "bg-[var(--muted)]/20 text-[var(--foreground)]" : "text-[var(--muted-foreground)] hover:bg-[var(--muted)]/10 hover:text-[var(--foreground)]")}
                      >
                        <Github className="w-4 h-4" /> {repo}
                      </div>
                    )) : <div className="px-4 py-4 text-center text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">No results for &quot;{searchQuery}&quot;</div>}
                  </motion.div>
                )}
              </div>
            </div>
          ...
          >
            <h2 className="text-[7px] md:text-[9px] font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-b from-[var(--foreground)] to-[var(--muted-foreground)]">
              Global Edge Network
            </h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {[
                ...
                <div key={feat.name} className="group relative p-8 rounded-[2rem] border border-[var(--border)] bg-[var(--card)] backdrop-blur-sm hover:border-[var(--muted)] transition-all duration-500 text-center overflow-hidden">
                  <div className="absolute top-4 right-6 text-[7px] font-bold uppercase tracking-wider text-[var(--muted)]/30 group-hover:text-[var(--foreground)]/30 tabular-nums transition-colors" aria-hidden="true">0{i + 1}</div>
                  ...
                  <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] block">{feat.name}</span>
                </div>
              ))}
            </div>
          </motion.div>
      ...
      <footer className="relative z-10 border-t border-[var(--border)] py-12 mt-40">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link href="/" className="flex items-center justify-center gap-2 mb-4 group w-fit mx-auto" aria-label="Deployify Home">
            <Rocket className="w-6 h-6 text-[var(--foreground)] group-hover:rotate-12 transition-transform" />
            <span className="text-[9px] font-bold">Deployify</span>
          </Link>
          <p className="text-[var(--muted-foreground)] text-[9px]">
