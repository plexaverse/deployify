    ...
    <div className={cn("flex flex-col h-full justify-between transition-all duration-500 rounded-2xl bg-[var(--card)]/40 backdrop-blur-sm border border-[var(--border)] hover:border-[var(--foreground)]/20", config.glow)}>
      ...
      <div className="flex justify-between w-full mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h3 className="text-[9px] font-bold text-[var(--foreground)] truncate group-hover:text-[var(--primary)] transition-colors uppercase tracking-tight">
              {project.name}
            </h3>
            <div className="flex items-center gap-1.5 mt-1.5">
              <Badge
                variant={config.variant}
                className="text-[7px] font-bold uppercase tracking-wider px-1.5 py-0.5 gap-1.5"
              >
      ...
      <div className="mt-auto space-y-4">
        {project.productionUrl && (
          <div className="flex items-center gap-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors px-1">
        ...
        {latestDeployment ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] font-mono bg-[var(--card-hover)]/30 p-2 rounded-lg border border-[var(--border)] group-hover:border-[var(--foreground)]/10 transition-all group/sha">
            ...
            <div className="flex items-center justify-between text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] px-1">
          ...
          <div className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] italic bg-[var(--card-hover)]/30 p-2 rounded-md border border-dashed border-[var(--border)] text-center">
            No deployments yet
          </div>
        )}
      </div>
