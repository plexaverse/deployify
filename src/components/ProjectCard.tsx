...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div className={cn("flex flex-col h-full justify-between transition-all duration-500 rounded-3xl bg-[var(--card)]/40 backdrop-blur-xl border border-[var(--border)] hover:border-[var(--foreground)]/20", config.glow)}>
      ...
      <div className="flex justify-between w-full mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h3 className="text-sm font-semibold text-[var(--foreground)] truncate group-hover:text-[var(--primary)] transition-colors uppercase tracking-tight">
              {project.name}
            </h3>
      ...
      <div className="mt-auto space-y-4">
        ...
        {latestDeployment ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)] font-mono bg-[var(--card-hover)]/30 p-2 rounded-xl border border-[var(--border)] group-hover:border-[var(--foreground)]/10 transition-all group/sha">
          ...
          <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)] italic bg-[var(--card-hover)]/30 p-2 rounded-xl border border-dashed border-[var(--border)] text-center">
            No deployments yet
          </div>
        )}
      </div>
