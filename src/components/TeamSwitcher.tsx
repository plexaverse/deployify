        ...
        <>
            <div className="relative mb-4" ref={containerRef}>
                <button
                    ...
                    className="flex items-center justify-between w-full p-2.5 text-[8px] font-bold uppercase tracking-wider border border-[var(--border)] rounded-xl hover:bg-[var(--card-hover)] transition-all duration-200 hover:shadow-sm"
                >
                    <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        <div className="flex flex-col items-start min-w-0 text-[8px] font-bold uppercase tracking-wider">
                    ...
                    <div className="absolute top-full left-0 right-0 z-50 mt-2 bg-[var(--card)] border border-[var(--border)] rounded-xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 p-1.5 space-y-1">
                        <div>
                            <button
                                ...
                                className="flex items-center w-full gap-3 p-2 text-[8px] font-bold uppercase tracking-wider rounded-lg hover:bg-[var(--card-hover)] transition-colors"
                            >
                        ...
                        {teams.length > 0 && (
                            <div className="pt-1.5 border-t border-[var(--border)] space-y-1">
                                <div className="px-2 pb-1.5 text-[8px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider">Teams</div>
                                {teams.map((team) => (
                                    <button
                                        key={team.id}
                                        onClick={() => {
                        ...
                        <div className="pt-1.5 border-t border-[var(--border)]">
                            <button
                                ...
                                className="flex items-center w-full gap-3 p-2 text-[8px] font-bold uppercase tracking-wider rounded-lg hover:bg-[var(--card-hover)] transition-colors text-[var(--muted-foreground)] hover:text-[var(--foreground)]"
                            >
