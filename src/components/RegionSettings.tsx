        ...
        <Card className="overflow-hidden p-0">
            <div className="p-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <h3 className="text-[11px] font-bold">Deployment Region</h3>
                </div>
            </div>
            ...
            <div className="p-6 space-y-4">
                {error && (
                    <div className="mb-4 p-3 rounded-lg bg-[var(--error-bg)] border border-[var(--error)] text-[var(--error)] text-[11px]">
                        {error}
                    </div>
                )}
                <div className="grid gap-2">
                    <Label htmlFor="region-select" className="text-[11px] font-bold">Region</Label>
                    <NativeSelect
                        id="region-select"
                ...
                <div className="flex items-center gap-2 h-6">
                    {saving && (
                        <span className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] animate-fade-in">
                            <Loader2 className="w-3.5 h-3.5 animate-spin" />
                            Saving...
                        </span>
                    )}
                    {saved && (
                        <span className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-wider text-[var(--success)] animate-fade-in">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-[11px]">
                        <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--info)] mb-1">Deployment Required</p>
