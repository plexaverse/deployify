    ...
    return (
        <Card className="overflow-hidden p-0">
            <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-[11px] font-bold">Environment Variables</h3>
                    </div>
                </div>
                {!isAdding && (
                    <MovingBorderButton
            ...
            <div className="p-6">
                    ...
                    <div className="mb-6 p-4 bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-xl animate-fade-in">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 space-y-1">
                                <h4 className="text-[11px] font-bold text-[var(--foreground)]">Detected Database Connection String</h4>
                                ...
                                <div className="flex items-center gap-3 pt-3">
                                    <Button
                                        ...
                                        className="h-8 text-[9px] font-bold uppercase tracking-wider bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-white"
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={handleAdd}
                                        disabled={isSubmitting}
                                        className="h-8 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]"
                                    >
                ...
                {error && (
                    <div className="mb-6 p-3 bg-[var(--error-bg)] border border-[var(--error)]/50 rounded-md flex items-center gap-3 text-[var(--error)] text-[9px] font-bold uppercase tracking-wider">
                ...
                <div className="mb-8 p-4 border border-[var(--border)] rounded-md bg-[var(--background)] animate-fade-in">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold">Key</Label>
                            <Input
                                type="text"
                                value={newKey}
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold">Value</Label>
                            <Input
                        ...
                        <div className="space-y-2 md:col-span-2">
                            <Label className="text-[11px] font-bold">Group (Optional)</Label>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start gap-8 mb-6">
                        <div className="flex items-center gap-3 p-3 rounded-lg border border-[var(--border)] bg-[var(--card)]/50">
                            ...
                            />
                            <Label htmlFor="is-secret" className="flex items-center gap-1.5 cursor-pointer text-[11px] font-bold">
                        ...
                        <div className="flex-1 space-y-4">
                            <div className="space-y-2">
                                <span className="text-[9px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider block">Target Environment Type</span>
                                <SegmentedControl
                                    options={[
                            ...
                            <div className="space-y-2">
                                <span className="text-[9px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider block">Scope</span>
                                <SegmentedControl
                                    options={[
                    ...
                    {uniqueGroups.map((group) => (
                        <div key={group} className="space-y-2">
                             <div className="flex items-center gap-2 px-1">
                                <span className="text-[9px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider">{group}</span>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-[var(--border)] bg-[var(--muted)]/5">
                                            <th className="py-3 px-4 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] w-[30%]">Key</th>
                                            <th className="py-3 px-4 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] w-[30%]">Value</th>
                                            <th className="py-3 px-4 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Type</th>
                                            <th className="py-3 px-4 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Scope</th>
                                            <th className="py-3 px-4 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] text-right">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr key={env.id} className="border-b border-[var(--border)] group hover:bg-[var(--card-hover)] transition-colors last:border-0">
                                                <td className="py-4 px-4 font-mono">
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[var(--primary)] text-[11px]">{env.key}</span>
                                                        {env.isSecret && (
                                                            <span title="Secret">
                                                ...
                                                <td className="py-4 px-4">
                                                    <span className="text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-[var(--muted)]/10 border border-[var(--border)] text-[var(--muted-foreground)]">
