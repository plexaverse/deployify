                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                <div className="flex items-center gap-3 pt-3">
                                    <Button
                                        ...
                                        className="h-8 text-[10px] font-bold uppercase tracking-wider bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-[var(--primary-foreground)]"
                                    >
                                            ...
                                            <tr key={env.id} className="border-b border-[var(--border)] group hover:bg-[var(--card-hover)] transition-colors last:border-0">
                                                <td className="py-4 px-4 font-mono">
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[var(--primary)] text-[10px] font-bold">{env.key}</span>
                                                        {env.isSecret && (
                                                            <span title="Secret">
