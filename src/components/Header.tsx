...
export function Header() {
    ...
    return (
        <header className="sticky top-0 z-30 flex items-center justify-between w-full h-14 px-6 bg-[var(--background)] border-b border-[var(--border)]">
            <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-[7px] font-bold uppercase tracking-wider overflow-x-auto no-scrollbar">
                <Link
                    href="/dashboard"
            ...
            <div className="flex items-center gap-4 ml-4">
                ...
                >
                    ...
                    <span className="text-[7px] font-bold uppercase tracking-wider flex-1 text-left">SEARCH PROJECTS...</span>
                    <div className="flex items-center gap-0.5 text-[7px] font-bold uppercase tracking-wider font-mono opacity-50">
