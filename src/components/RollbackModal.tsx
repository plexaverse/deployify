                    ...
                    <div className="flex items-center justify-between p-6 border-b border-[var(--border)] bg-[var(--background)] shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <h3 className="text-xs font-bold tracking-tight text-[var(--foreground)]">Confirm Rollback</h3>
                            </div>
                        </div>
                        <Button
                            variant="ghost"
                    ...
                    <div className="p-6 overflow-y-auto">
                        ...
                        <div className="bg-[var(--background)] rounded-xl p-6 border border-[var(--border)] space-y-4 shadow-sm">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs font-bold line-clamp-2 text-[var(--foreground)]">{deployment.gitCommitMessage}</p>
                            </div>
