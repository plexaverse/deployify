        ...
        <>
            ...
            <div className="md:hidden fixed top-0 left-0 right-0 z-40 flex items-center justify-between p-4 bg-[var(--card)] border-b border-[var(--border)] h-16">
                <Link href="/dashboard" className="flex items-center gap-2 group">
                    ...
                    <span className="text-[9px] font-bold gradient-text">Deployify</span>
                </Link>
                <motion.button
                    whileTap={{ scale: 0.95 }}
            ...
            `}>
                ...
                <nav className="flex-1 p-4 overflow-y-auto space-y-6">
                    {navGroups.map((group) => (
                        <div key={group.label}>
                            <h3 className="text-[7px] font-bold text-[var(--muted-foreground)] uppercase tracking-wider mb-3 px-3">
                                {group.label}
                            </h3>
                                        ...
                                        <li key={item.name} className="relative">
                                            ...
                                            <motion.div whileTap={{ scale: 0.98 }}>
                                                <Link
                                                    href={item.href}
                                                    className={cn(
                                                        "flex items-center gap-3 px-3 py-3 md:py-2 rounded-md text-[7px] font-bold uppercase tracking-wider transition-all duration-200",
                                                        isActive
                ...
                <div className="p-4 border-t border-[var(--border)] space-y-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-3 px-3 py-2">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 min-w-0">
                                    <p className="text-[9px] font-bold truncate min-w-0 text-[var(--foreground)]">
                                ...
                                <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] truncate">
                        ...
                        <motion.a
                            ...
                            className="flex items-center gap-2 px-3 py-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--error)] transition-colors mt-1"
                        >
