        ...
        <>
            ...
            `}>
                ...
                <nav className="flex-1 p-4 overflow-y-auto space-y-6">
                    {navGroups.map((group) => (
                        <div key={group.label}>
                            <h3 className="text-[10px] font-bold text-[var(--muted-foreground)] uppercase tracking-[0.2em] mb-3 px-3">
                                {group.label}
                            </h3>
                                        ...
                                        <li key={item.name} className="relative">
                                            ...
                                            <motion.div whileTap={{ scale: 0.98 }}>
                                                <Link
                                                    href={item.href}
                                                    className={cn(
                                                        "flex items-center gap-3 px-3 py-3 md:py-2 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-200",
                                                        isActive
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-3 px-3 py-2">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)] truncate">
                        ...
                        <motion.a
                            ...
                            className="flex items-center gap-2 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted-foreground)] hover:text-[var(--error)] transition-colors mt-1"
                        >
