                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Welcome</span>
                            <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Welcome to Deployify</h1>
                        </div>
                    </div>
                    <p className="text-[var(--muted-foreground)] text-[9px] max-w-lg mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <h3 className={cn(
                                    "font-bold text-[7px] uppercase tracking-wider transition-colors",
                                ...
                                <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] max-w-[140px] mx-auto hidden md:block">
                                    {step.description}
                                </p>
                            </div>
                        </motion.div>
