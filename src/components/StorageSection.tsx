            ...
            <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-[9px] font-bold">Storage & Databases</h3>
                    </div>
                </div>
                {!isAdding && (
                    <MovingBorderButton
                    ...
                    <div className="mb-8 p-6 border border-[var(--border)] rounded-xl bg-[var(--background)] animate-fade-in space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="space-y-2">
                                <Label className="text-[9px] font-bold">Connector Name</Label>
                                <Input
                                    value={name}
                            ...
                            <div className="space-y-2">
                                <Label className="text-[9px] font-bold flex items-center justify-between">
                                    ...
                                    <Button
                                        ...
                                        className="h-5 px-1.5 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] hover:bg-[var(--primary)]/10"
                                    >
                            ...
                            <div className="space-y-2">
                                <Label className="text-[9px] font-bold">GCP Region (Optional)</Label>
                                <Input
                                    value={region}
                            ...
                            <div className="space-y-2">
                                <Label className="text-[9px] font-bold">Database Type</Label>
                                <NativeSelect
                                    value={type}
                            ...
                            <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg space-y-3 animate-in fade-in slide-in-from-top-2">
                                <div className="flex items-center justify-between border-b border-[var(--primary)]/10 pb-2">
                                    <div className="flex items-center gap-4">
                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Infrastructure Health</Label>
                                        <div className="flex items-center gap-3">
                                            <span className="text-[7px] font-bold text-[var(--success)]">{discoveredResources.filter(r => !r.isOrphaned).length} ACTIVE</span>
                                            <span className="text-[7px] font-bold text-[var(--error)]">{discoveredResources.filter(r => r.isOrphaned).length} ORPHANED</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {discoveredResources.some(r => r.isOrphaned) && (
                                            <Button
                                                ...
                                                className="h-5 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--error)] hover:bg-[var(--error)]/10"
                                            >
                                                Purge All Orphans
                                            </Button>
                                        )}
                                        <Button variant="ghost" size="sm" onClick={() => setDiscoveredResources([])} className="h-5 text-[7px] font-bold uppercase">Clear</Button>
                                    </div>
                                </div>
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex items-center justify-between w-full gap-2">
                                                    <span className="text-[7px] font-bold uppercase truncate pr-6">{res.name}</span>
                                                    {res.isOrphaned && (
                                                        <span className="text-[7px] px-1 rounded bg-[var(--error)]/10 text-[var(--error)] font-bold uppercase shrink-0">Orphaned</span>
                                                    )}
                                                </div>
                                                <div className="flex items-center gap-2 mt-1">
                                                    <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)] px-1 bg-[var(--muted)]/20 rounded">{res.type.replace(/-/g, ' ')}</span>
                                                    <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">{res.region}</span>
                                                </div>
                                            </button>
                        ...
                        {!editingId && (
                            <div className="space-y-2">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Setup Method</Label>
                                <SegmentedControl
                                    options={[
                            ...
                            {!provision ? (
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                        <div className="space-y-0.5">
                                            <Label className="text-[9px] font-bold">Secret Only Mode</Label>
                                            <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Store in Secret Manager without auto-injection</p>
                                        </div>
                                        <input
                                            type="checkbox"
                                            checked={secretOnly}
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[9px] font-bold">Connection String / Secret</Label>
                                    <Input
                                        type="password"
                                    ...
                                    />
                                        <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] flex items-center gap-1.5">
                                    ...
                                    {(type === 'supabase' || type === 'mongodb-atlas' || type === 'planetscale' || type === 'neon') && (
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                <div className="space-y-0.5">
                                                    <Label className="text-[9px] font-bold">SSL Required</Label>
                                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Enforce encrypted connections</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                                    checked={sslRequired}
                                            ...
                                            {!editingId && (
                                                <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                    <div className="space-y-0.5">
                                                        <Label className="text-[9px] font-bold">API Auto-Sync</Label>
                                                        <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Sync credentials via provider API</p>
                                                    </div>
                                                    <input
                                                        type="checkbox"
                                                        checked={autoSync}
                                            ...
                                            {autoSync && (
                                                <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg space-y-4 animate-in slide-in-from-top-2">
                                                    <div className="space-y-2">
                                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Provider API Key</Label>
                                                        <Input
                                                            type="password"
                                                            value={providerApiKey}
                                                            onChange={(e) => setProviderApiKey(e.target.value)}
                                                            placeholder="ENTER PROVIDER API KEY..."
                                                            className="h-8 text-[7px] font-mono placeholder:text-[7px]"
                                                        />
                                                    </div>

                                                    {type === 'supabase' && (
                                                        <div className="space-y-2">
                                                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Supabase Project ID</Label>
                                                            <Input
                                                                value={supabaseId}
                                                    ...
                                                    {type === 'mongodb-atlas' && (
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Group ID</Label>
                                                                <Input
                                                            ...
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Cluster Name</Label>
                                                                <Input
                                                    ...
                                                    {type === 'planetscale' && (
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Organization</Label>
                                                                <Input
                                                            ...
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Database</Label>
                                                                <Input
                                                                    value={planetscaleDb}
                                                    ...
                                                    {type === 'neon' && (
                                                        <div className="space-y-2">
                                                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Neon Project ID</Label>
                                                            <Input
                                                                value={neonProjectId}
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg flex items-start gap-3">
                                        ...
                                        <div className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                    ...
                                    {type.includes('cloud-sql') && (
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                <div className="space-y-0.5">
                                                    <Label className="text-[7px] font-bold uppercase tracking-wider">High Availability</Label>
                                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Multi-zone redundancy</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                            ...
                                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                <div className="space-y-0.5">
                                                    <Label className="text-[7px] font-bold uppercase tracking-wider">PITR Recovery</Label>
                                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Point-in-time snapshots</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                                    checked={pitrEnabled}
                                            ...
                                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                <div className="space-y-0.5">
                                                    <Label className="text-[7px] font-bold uppercase tracking-wider">Deletion Protection</Label>
                                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Prevent accidental delete</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                    ...
                                    <div className={cn("space-y-6 transition-opacity", secretOnly && "opacity-40 pointer-events-none")}>
                                        <div className="space-y-2">
                                            <Label className="text-[9px] font-bold">Environment Variable Key</Label>
                                            <Input
                                    value={envKey}
                                ...
                                />
                                        ...
                                        <div className="space-y-4 pt-2">
                                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                <div className="space-y-0.5">
                                                    <div className="flex items-center gap-2">
                                                        <Label className="text-[9px] font-bold">Preview Branching</Label>
                                                        <span className="text-[7px] px-1.5 py-0.5 rounded bg-[var(--primary)]/10 text-[var(--primary)] font-bold uppercase tracking-wider border border-[var(--primary)]/20">BETA</span>
                                                    </div>
                                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Isolated database for Preview Deployments</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                            ...
                                            {branchingEnabled && (
                                                <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg space-y-4 animate-in slide-in-from-top-2">
                                                    <div className="space-y-2">
                                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Database Name Template</Label>
                                                        <Input
                                                            ...
                                                            className="h-8 text-[7px] font-mono placeholder:text-[7px]"
                                                        />
                                                        <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/70">
                                                    ...
                                                    <div className="space-y-2">
                                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Seed Command (Optional)</Label>
                                                        <Input
                                                            value={seedCommand}
                                        ...
                                        {(type.includes('sql') || type === 'planetscale' || type === 'supabase' || type === 'neon' || type === 'memorystore-redis') && (
                                            <div className="space-y-4 pt-2 border-t border-[var(--border)] mt-4">
                                                <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-lg bg-[var(--muted)]/5">
                                                    <div className="space-y-0.5">
                                                        <Label className="text-[9px] font-bold">Automated Migrations</Label>
                                                        <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Run migrations automatically during deployment</p>
                                                    </div>
                                                    <input
                                                        type="checkbox"
                                                ...
                                                {autoMigrationEnabled && (
                                                    <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg space-y-4 animate-in slide-in-from-top-2">
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Migration Command</Label>
                                                                <Input
                                                            ...
                                                            <div className="space-y-2">
                                                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Rollback Command</Label>
                                                                <Input
                                                        ...
                                                        <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/70">
                        ...
                        <div className="space-y-2">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Environment Scope</Label>
                            <SegmentedControl
                                options={[
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-1 w-full">
                                        <div className="flex items-center gap-2">
                                            <h4 className="font-bold text-[9px]">{config.name}</h4>
                                        {config.region && projectRegion && config.region !== projectRegion && (
                                            <button
                                                ...
                                                className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--error)]/10 text-[var(--error)] font-bold uppercase tracking-wider border border-[var(--error)]/20 flex items-center gap-1 hover:bg-[var(--error)]/20 transition-colors"
                                            ...
                                            {config.connectionStringSecretId && !config.metadata?.secretOnly && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--success)]/10 text-[var(--success)] font-bold uppercase tracking-wider border border-[var(--success)]/20 flex items-center gap-1" title="Natively mounted from Secret Manager">
                                                    <ShieldCheck className="w-2.5 h-2.5" />
                                                    SECURELY MOUNTED
                                                </span>
                                            )}
                                            {config.connectionStringSecretId && !!config.metadata?.secretOnly && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--muted)]/20 text-[var(--muted-foreground)] font-bold uppercase tracking-wider border border-[var(--border)] flex items-center gap-1" title="Stored in Secret Manager but not injected">
                                                    <Shield className="w-2.5 h-2.5" />
                                                    SECRET ONLY
                                                </span>
                                            )}
                                            {config.ssl && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--info)]/10 text-[var(--info)] font-bold uppercase tracking-wider border border-[var(--info)]/20 flex items-center gap-1" title="Encrypted connection enforced">
                                                    <ShieldCheck className="w-2.5 h-2.5" />
                                                    SSL
                                                </span>
                                            )}
                                            {!!config.metadata?.firewallSynced && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--success)]/10 text-[var(--success)] font-bold uppercase tracking-wider border border-[var(--success)]/20 flex items-center gap-1" title={`Regional egress IPs allowed in provider firewall. Last sync: ${config.metadata.lastFirewallSyncAt ? new Date(config.metadata.lastFirewallSyncAt as string).toLocaleString() : 'N/A'}`}>
                                                    <Network className="w-2.5 h-2.5" />
                                                    FIREWALL SYNCED
                                                </span>
                                            )}
                                            {config.type.includes('cloud-sql') && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--primary)]/10 text-[var(--primary)] font-bold uppercase tracking-wider border border-[var(--primary)]/20 flex items-center gap-1">
                                                    <Zap className="w-2.5 h-2.5" />
                                                    IAM AUTH
                                                </span>
                                            )}
                                            {config.branchingSettings?.enabled && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--info)]/10 text-[var(--info)] font-bold uppercase tracking-wider border border-[var(--info)]/20 flex items-center gap-1" title={`Branching template: ${config.branchingSettings.template}`}>
                                                    <GitBranch className="w-2.5 h-2.5" />
                                                    BRANCHING ACTIVE
                                                </span>
                                            )}
                                            {config.autoMigration && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--success)]/10 text-[var(--success)] font-bold uppercase tracking-wider border border-[var(--success)]/20 flex items-center gap-1" title={`Auto-migration command: ${config.migrationCommand}`}>
                                                    <RefreshCw className="w-2.5 h-2.5" />
                                                    AUTO-MIGRATE
                                                </span>
                                            )}
                                            {!!config.metadata?.optimization && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--primary)]/10 text-[var(--primary)] font-bold uppercase tracking-wider border border-[var(--primary)]/20 flex items-center gap-1 animate-pulse">
                                                    <Sparkles className="w-2.5 h-2.5" />
                                                    OPTIMIZATION AVAILABLE
                                                </span>
                                            )}
                                            {!!config.metadata?.highAvailability && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--warning)]/10 text-[var(--warning)] font-bold uppercase tracking-wider border border-[var(--warning)]/20 flex items-center gap-1" title="Multi-zone redundancy enabled">
                                                    <Zap className="w-2.5 h-2.5" />
                                                    HA ENABLED
                                                </span>
                                            )}
                                            {!!config.metadata?.pitrEnabled && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--primary)]/10 text-[var(--primary)] font-bold uppercase tracking-wider border border-[var(--primary)]/20 flex items-center gap-1" title="Point-in-time recovery active">
                                                    <HistoryIcon className="w-2.5 h-2.5" />
                                                    PITR ACTIVE
                                                </span>
                                            )}
                                            {!!config.metadata?.deletionProtection && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--info)]/10 text-[var(--info)] font-bold uppercase tracking-wider border border-[var(--info)]/20 flex items-center gap-1" title="Deletion protection enabled">
                                                    <ShieldCheck className="w-2.5 h-2.5" />
                                                    PROTECTED
                                                </span>
                                            )}
                                            {!!config.metadata?.tier && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--muted)]/20 text-[var(--muted-foreground)] font-bold uppercase tracking-wider border border-[var(--border)] flex items-center gap-1" title={`Discovered Resource Tier: ${config.metadata.tier}`}>
                                                    <Zap className="w-2.5 h-2.5" />
                                                    TIER: {config.metadata.tier as string}
                                                </span>
                                            )}
                                            {config.activeAlerts && config.activeAlerts.length > 0 && (
                                                <span className="text-[7px] px-1.5 py-0.5 rounded-md bg-[var(--error)]/10 text-[var(--error)] font-bold uppercase tracking-wider border border-[var(--error)]/20 flex items-center gap-1" title={config.activeAlerts.join('\n')}>
                                                    <AlertTriangle className="w-2.5 h-2.5" />
                                            ...
                                            {config.status === 'error' && config.lastError && (
                                                <span className="text-[7px] font-bold text-[var(--error)] uppercase truncate max-w-[200px]" title={config.lastError}>
                                                    — {config.lastError}
                                                </span>
                                            )}
                                            {config.status === 'active' && !!config.metadata?.health && (
                                                <span className={cn(
                                                    "text-[7px] font-bold uppercase flex items-center gap-1",
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--muted)]/10 px-2 py-0.5 rounded-full border border-[var(--border)]">
                                                    {config.type.replace(/-/g, ' ')}
                                                </span>
                                                {!config.metadata?.secretOnly && (
                                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                {config.lastRotatedAt && (
                                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">
                                                ...
                                                <div className="p-2 rounded-lg bg-[var(--muted)]/10 border border-[var(--border)]">
                                                    <div className="flex items-center justify-between mb-1">
                                                        <div className="flex items-center gap-1.5">
                                                            ...
                                                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">CPU</span>
                                                        </div>
                                                        <span className="text-[7px] font-mono font-bold text-[var(--primary)]">{metrics[config.id]?.cpuUtilization || 0}%</span>
                                                    </div>
                                                ...
                                                <div className="p-2 rounded-lg bg-[var(--muted)]/10 border border-[var(--border)]">
                                                    <div className="flex items-center justify-between mb-1">
                                                        <div className="flex items-center gap-1.5">
                                                            ...
                                                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Memory</span>
                                                        </div>
                                                        <span className="text-[7px] font-mono font-bold text-[var(--success)]">{metrics[config.id]?.memoryUtilization || 0}%</span>
                                                    </div>
                                                    <div className="h-1.5 w-full bg-[var(--muted)]/20 rounded-full overflow-hidden">
                                                        <div
                                                    ...
                                                    <div className="p-2 rounded-lg bg-[var(--muted)]/10 border border-[var(--border)] col-span-2 md:col-span-1">
                                                        <div className="flex items-center justify-between mb-1">
                                                            <div className="flex items-center gap-1.5">
                                                                ...
                                                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Disk</span>
                                                            </div>
                                                            <span className="text-[7px] font-mono font-bold text-[var(--warning)]">{metrics[config.id]?.diskUtilization}%</span>
                                                        </div>
                                                        <div className="h-1.5 w-full bg-[var(--muted)]/20 rounded-full overflow-hidden">
                                                            <div
                                        ...
                                        {isRotating === config.id && (
                                            <div className="mt-3 p-3 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-lg space-y-3 animate-fade-in">
                                                <div className="space-y-1.5">
                                                    <Label className="text-[7px] font-bold uppercase tracking-wider">New Connection String</Label>
                                                    <Input
                                                        type="password"
                                                        value={rotateConnectionString}
                                                        onChange={(e) => setRotateConnectionString(e.target.value)}
                                                        placeholder="PASTE NEW CONNECTION STRING..."
                                                        className="font-mono text-[7px] h-8 placeholder:text-[7px]"
                                                    />
                                                </div>
                                                <div className="flex justify-end gap-2">
                                                    <Button
                                                        ...
                                                        disabled={isSubmitting}
                                                        className="h-7 text-[7px] font-bold uppercase tracking-wider"
                                                    >
                                                        Cancel
                                                    </Button>
                                                    <Button
                                                        ...
                                                        className="h-7 text-[7px] font-bold uppercase tracking-wider bg-[var(--primary)]"
                                                    >
                                                        Rotate Credentials
                                                    </Button>
                                                </div>
                ...
                <div className="mt-6 flex items-start gap-3 p-4 bg-[var(--info-bg)] border border-[var(--info)]/20 rounded-xl">
                    ...
                    <div className="text-[9px]">
                        ...
                        <p className="text-[var(--muted-foreground)] leading-relaxed">
                            Deployify automatically injects the appropriate environment variables (like <code className="text-[7px] font-bold uppercase tracking-wider bg-[var(--muted)]/20 px-1 rounded">DATABASE_URL</code>) into your services based on these connectors.
                        </p>
                    </div>
                </div>
            </div>
                ...
                description={
                    <div className="space-y-4">
                        ...
                        {isScaling?.type.includes('cloud-sql') ? (
                            <div className="space-y-2">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Machine Tier</Label>
                                <NativeSelect
                                    value={scaleTier}
                            ...
                            <div className="space-y-2">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Memory Capacity (GB)</Label>
                                <div className="flex items-center gap-4">
                                    <input
                                        type="range"
                                        min="1"
                                    ...
                                    />
                                    <span className="text-[9px] font-mono font-bold w-12 text-center">{scaleSizeGb} GB</span>
                                </div>
                            </div>
                        ) : null}
                    </div>
                ...
                description={
                    <div className="space-y-6">
                        <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-xl space-y-4">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Trigger Manual Backup</Label>
                            <div className="flex gap-2">
                                <Input
                                    value={backupDescription}
                                    onChange={(e) => setBackupDescription(e.target.value)}
                                    placeholder="BACKUP DESCRIPTION..."
                                    className="h-9 text-[7px] font-bold uppercase placeholder:text-[7px]"
                                />
                                <Button
                                    onClick={handleCreateBackup}
                                    disabled={isSubmitting}
                                    className="h-9 px-4 text-[7px] font-bold uppercase bg-[var(--primary)]"
                                >
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Backup History</Label>
                                {!!isManagingBackups?.metadata?.pitrEnabled && (
                                    <span className="text-[7px] font-bold uppercase text-[var(--primary)] flex items-center gap-1">
                            ...
                            {!!isManagingBackups?.metadata?.pitrEnabled && (
                                <div className="p-3 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-xl space-y-3 mb-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Point-in-Time Recovery</Label>
                                    </div>
                                    <div className="flex gap-2">
                                        <Input
                                            type="datetime-local"
                                            ...
                                            className="h-8 text-[7px] font-bold uppercase"
                                        />
                                        <Button
                                            onClick={() => {
                                                try {
                                            ...
                                            className="h-8 px-3 text-[7px] font-bold uppercase bg-[var(--primary)]"
                                        >
                                            Restore
                                        </Button>
                                    </div>
                                    <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">
                            ...
                            <div className="max-h-60 overflow-y-auto space-y-2 pr-1 custom-scrollbar">
                                {isLoadingBackups ? (
                                    <div className="py-8 flex flex-col items-center justify-center gap-2">
                                        ...
                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Fetching backups...</span>
                                    </div>
                                ) : backups.length === 0 ? (
                                    <div className="py-8 text-center border border-dashed border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">No backups found</span>
                                    </div>
                                ) : (
                                    backups.map(b => (
                                        <div key={b.id} className="p-3 border border-[var(--border)] rounded-xl bg-[var(--background)] flex items-center justify-between group">
                                            <div className="space-y-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[7px] font-mono font-bold">{b.id}</span>
                                                </div>
                                                <p className="text-[7px] font-bold uppercase text-[var(--foreground)]">{b.description || 'AUTOMATED BACKUP'}</p>
                                                <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">{new Date(b.startTime).toLocaleString()}</p>
                                            </div>
                                            {b.status === 'SUCCESSFUL' && (
                                                <Button
                                                    variant="outline"
                                                    ...
                                                    disabled={isSubmitting}
                                                    className="h-7 text-[7px] font-bold uppercase tracking-wider border-[var(--primary)]/20 text-[var(--primary)] hover:bg-[var(--primary)]/10 opacity-0 group-hover:opacity-100 transition-opacity"
                                                >
                                                    Restore
                                                </Button>
                                            )}
                    ...
                    <div className="space-y-6">
                        {isManagingMigrations && activeMigrations[isManagingMigrations.id] ? (
                            <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                                ...
                                <div className="p-4 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px] overflow-hidden">
                                ...
                                {activeMigrations[isManagingMigrations.id].error && (
                                    <div className="p-3 bg-[var(--error)]/10 border border-[var(--error)]/20 rounded-lg flex items-start gap-2">
                                        ...
                                        <p className="text-[7px] font-bold uppercase text-[var(--error)]">{activeMigrations[isManagingMigrations.id].error}</p>
                                    </div>
                                )}
                                ...
                                {(activeMigrations[isManagingMigrations.id].status === 'SUCCESS' || activeMigrations[isManagingMigrations.id].status === 'FAILURE') && (
                                    <Button
                                        ...
                                        className="w-full text-[7px] font-bold uppercase tracking-wider"
                                    >
                            ...
                            <div className="p-4 border border-[var(--primary)]/20 bg-[var(--primary)]/5 rounded-xl space-y-4 animate-in fade-in">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Run Manual Migration</Label>
                                <div className="flex gap-2">
                                    <Input
                                        value={migrationCommand}
                                        onChange={(e) => setMigrationCommand(e.target.value)}
                                        placeholder="E.G. prisma migrate deploy"
                                        className="h-9 text-[7px] font-mono font-bold placeholder:text-[7px]"
                                    />
                                    <Button
                                ...
                                <div className="pt-2 border-t border-[var(--border)]">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--error)]">Danger: Rollback Operation</Label>
                                    <div className="flex gap-2 mt-2">
                                        <Input
                                            value={rollbackCommand}
                                            onChange={(e) => setRollbackCommand(e.target.value)}
                                            placeholder="E.G. prisma migrate resolve --rolled-back"
                                            className="h-9 text-[7px] font-mono font-bold placeholder:text-[7px] border-[var(--error)]/30"
                                        />
                                        <Button
                                            onClick={handleRunRollback}
                                            disabled={isLoading}
                                            variant="outline"
                                            className="h-9 px-4 text-[7px] font-bold uppercase border-[var(--error)]/30 text-[var(--error)] hover:bg-[var(--error)]/10"
                                        >
                                            Rollback
                                        </Button>
                                    </div>
                                </div>
                                <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Migration History</Label>
                            <div className="max-h-60 overflow-y-auto space-y-2 pr-1 custom-scrollbar">
                                {isLoadingMigrations ? (
                                    <div className="py-8 flex flex-col items-center justify-center gap-2">
                                        <Loader2 className="w-6 h-6 animate-spin text-[var(--primary)]" />
                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Fetching migrations...</span>
                                    </div>
                                ) : migrations.length === 0 ? (
                                    <div className="py-8 text-center border border-dashed border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">No migration history found</span>
                                    </div>
                                ) : (
                                    migrations.map(m => (
                                        <div key={m.id} className="space-y-3">
                                            <div className={cn(
                                                ...
                                                <div className="space-y-1">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {m.drifted && (
                                                            <span className="text-[7px] font-bold uppercase px-1.5 py-0.5 rounded bg-[var(--error)]/20 text-[var(--error)] animate-pulse border border-[var(--error)]/30">
                                                                DRIFTED
                                                            </span>
                                                        )}
                                                        <span className="text-[7px] font-mono font-bold text-[var(--muted-foreground)]">{m.provider?.toUpperCase()}</span>
                                                    </div>
                                                    <p className="text-[7px] font-bold uppercase text-[var(--foreground)] truncate max-w-[280px]" title={m.name}>{m.name}</p>
                                                    <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <Button
                                                        ...
                                                        className={cn(
                                                            "h-8 px-2 text-[7px] font-bold uppercase tracking-wider transition-colors",
                                            ...
                                            {previewMigration?.name === m.name && (
                                                <div className="p-4 bg-black/40 border border-[var(--primary)]/20 rounded-xl font-mono text-[7px] animate-in slide-in-from-top-2 fade-in">
                                                    <div className="flex items-center justify-between mb-2 pb-2 border-b border-[var(--border)]">
                ...
                description={
                    <div className="space-y-6">
                        <div className="flex items-center justify-between p-4 border border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                            <div className="space-y-0.5">
                                <Label className="text-[9px] font-bold">Enable Automated Alerts</Label>
                                <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Notify when resource usage exceeds thresholds</p>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        <div className={cn("space-y-6 transition-opacity", !alertsEnabled && "opacity-40 pointer-events-none")}>
                            <div className="flex items-center justify-between p-4 border border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                                <div className="space-y-0.5">
                                    <Label className="text-[9px] font-bold">Email Notifications</Label>
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Send alerts to your account email address</p>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">CPU Threshold</Label>
                                    <span className="text-[7px] font-mono font-bold text-[var(--primary)]">{alertCpu}%</span>
                                </div>
                                <input
                                    type="range"
                                    min="1"
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Memory Threshold</Label>
                                    <span className="text-[7px] font-mono font-bold text-[var(--success)]">{alertMemory}%</span>
                                </div>
                                <input
                                    type="range"
                                    min="1"
                            ...
                            {isManagingAlerts?.type.includes('cloud-sql') && (
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Disk Threshold</Label>
                                        <span className="text-[7px] font-mono font-bold text-[var(--warning)]">{alertDisk}%</span>
                                    </div>
                                    <input
                                        type="range"
                                        min="1"
                    ...
                    <div className="space-y-6">
                        <div className="p-4 bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-xl space-y-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Standardized Interface</span>
                            </div>
                            <p className="text-[9px]">
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Environment Variable</Label>
                            <div className="p-3 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px] flex items-center justify-between">
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Node.js Access</Label>
                            <div className="p-3 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px]">
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Python Access</Label>
                            <div className="p-3 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px]">
                                <code className="text-[var(--foreground)]/80">
                                    import os<br />
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Go Access</Label>
                            <div className="p-3 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px]">
                                <code className="text-[var(--foreground)]/80">
                                    import &quot;os&quot;<br />
                        ...
                        <div className="space-y-3">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Deployment Region</Label>
                            <div className="flex items-center gap-2 px-1">
                                <Server className="w-3.5 h-3.5 text-[var(--muted-foreground)]" />
                                <span className="text-[7px] font-bold uppercase tracking-wider">{(isShowingGuide?.metadata?.region as string) || projectRegion || 'GLOBAL/AUTO'}</span>
                            </div>
                        </div>
                        ...
                        {egressIps && (
                            <div className="space-y-4 pt-4 border-t border-[var(--border)]">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">IP Allowlist Assistant</span>
                                </div>
                                <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                ...
                                <div className="space-y-2">
                                    {egressIps.ips.map(ip => (
                                        <div key={ip} className="p-2 bg-black/40 border border-[var(--border)] rounded-lg font-mono text-[7px] flex items-center justify-between group">
                                ...
                                {egressIps.isFallback && (
                                    <p className="text-[7px] font-bold uppercase text-[var(--warning)] flex items-center gap-1.5">
                        ...
                        <div className="p-4 bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-xl space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Deep Multi-Layer Scan</span>
                                </div>
                                {!isDiagnosing && !diagnosticResult && (
                                    <Button
                                        onClick={handleDiagnose}
                                        className="h-8 text-[7px] font-bold uppercase tracking-wider bg-[var(--primary)]"
                                    >
                                        Run Diagnostics
                                    </Button>
                                )}
                        ...
                        {isDiagnosing && (
                            <div className="py-8 flex flex-col items-center justify-center gap-4 animate-in fade-in">
                                ...
                                <div className="text-center">
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] animate-pulse">Scanning infrastructure...</p>
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] mt-1">Checking multi-layer connectivity</p>
                                </div>
                            </div>
                        )}
                        ...
                        {diagnosticResult && (
                            <div className="space-y-4 animate-in slide-in-from-top-2">
                                        ...
                                        <div key={i} className="p-3 border border-[var(--border)] rounded-xl bg-[var(--background)] space-y-2">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-[7px] font-bold uppercase tracking-wider">{step.name}</span>
                                                </div>
                                                {step.latency !== undefined && (
                                                    <span className="text-[7px] font-mono font-bold text-[var(--muted-foreground)]">{step.latency}ms</span>
                                                )}
                                            </div>
                                            {step.error && (
                                                <div className="p-2 bg-[var(--error)]/5 rounded border border-[var(--error)]/10">
                                                    <p className="text-[7px] font-bold uppercase text-[var(--error)]">{step.error}</p>
                                                </div>
                                            )}
                                            {step.recommendation && (
                                                <div className="p-2 bg-[var(--primary)]/5 rounded border border-[var(--primary)]/10 flex items-start gap-2">
                                                    ...
                                                    <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)] leading-relaxed">
                                ...
                                <div className="p-4 bg-[var(--muted)]/5 border border-[var(--border)] rounded-xl flex items-center justify-between">
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Total Scan Time</span>
                                    <span className="text-[7px] font-mono font-bold">{diagnosticResult.overallLatency}ms</span>
                                </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-3 border border-[var(--border)] rounded-xl space-y-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">IAM Identity</span>
                                </div>
                                <p className="text-[7px] font-bold uppercase truncate">roles/cloudsql.client</p>
                            </div>
                            <div className="p-3 border border-[var(--border)] rounded-xl space-y-1">
                                <div className="flex items-center gap-2">
                                    <Network className="w-3.5 h-3.5 text-[var(--muted-foreground)]" />
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Network Mode</span>
                                </div>
                                <p className="text-[7px] font-bold uppercase truncate">Direct VPC Egress</p>
                            </div>
                        </div>
                    </div>
                }
                    ...
                    <div className="space-y-4">
                        ...
                        {!!storageToDelete?.metadata?.provisioned && (
                            <div className="p-3 rounded-lg bg-[var(--error)]/5 border border-[var(--error)]/20 flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--error)]">Delete actual GCP Resource</Label>
                                    <p className="text-[7px] font-bold uppercase text-[var(--error)]/60">Permantently destroy the provisioned instance</p>
                                </div>
                                <input
                                    type="checkbox"
                    ...
                    <div className="space-y-4">
                        ...
                        {(storageConfigs.find(c => c.id === isCloningId)?.type.includes('cloud-sql') || storageConfigs.find(c => c.id === isCloningId)?.type === 'memorystore-redis' || storageConfigs.find(c => c.id === isCloningId)?.type === 'firestore') && (
                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                                <div className="space-y-0.5">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider">Include Data snapshot</Label>
                                    <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">Automated GCS-based export/import</p>
                                </div>
                                <input
                                    type="checkbox"
                ...
                description={
                    <div className="space-y-4">
                        <div className="p-4 bg-[var(--error)]/5 border border-[var(--error)]/20 rounded-xl flex items-start gap-3">
                            ...
                            <div className="space-y-1">
                                <p className="text-[9px] font-bold text-[var(--error)] uppercase">Performance Optimization</p>
                                <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] leading-relaxed">
