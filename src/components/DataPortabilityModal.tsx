                ...
                <div className="bg-[var(--card)] border border-[var(--border)] w-full max-w-[500px] rounded-xl shadow-2xl flex flex-col overflow-hidden animate-fade-in">
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-[var(--border)] bg-[var(--background)] shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <h3 className="text-[9px] font-bold tracking-tight text-[var(--foreground)] uppercase">
                    ...
                    <div className="p-6 overflow-y-auto">
                        <div className="flex gap-1 bg-[var(--muted)]/20 p-1 rounded-xl border border-[var(--border)] mb-6">
                            <Button
                                ...
                                className={cn(
                                    "flex-1 h-8 text-[7px] font-bold uppercase tracking-wider",
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="font-mono text-[9px] placeholder:text-[7px] placeholder:font-bold placeholder:uppercase"
                                />
                            ...
                            {storage.type === 'firestore' ? (
                                <div className="space-y-2">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Collections to {mode === 'import' ? 'Import' : 'Export'} (CSV)</Label>
                                    <Input
                                        value={collections}
                                    ...
                                    />
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/60">
                                ...
                                mode === 'import' ? (
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Target Database</Label>
                                            <Input
                                                value={database}
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Import User</Label>
                                            <Input
                                                value={importUser}
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Databases to Export (CSV)</Label>
                                        <Input
                            ...
                            {storage.type === 'memorystore-redis' && (
                                <div className="p-3 bg-[var(--warning)]/10 border border-[var(--warning)]/20 rounded-xl flex items-start gap-3">
                                    ...
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--warning)] leading-relaxed">
                            ...
                            <div className="p-4 bg-[var(--info-bg)] border border-[var(--info)]/20 rounded-xl flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--info)]">Permissions Required</p>
                    ...
                    <div className="p-4 border-t border-[var(--border)] bg-[var(--background)] flex justify-between items-center gap-4 shrink-0">
                        ...
                        <Button
                            ...
                            className="bg-[var(--primary)] text-white text-[7px] font-bold uppercase tracking-wider h-10 px-6"
                        >
                            {isSubmitting ? (
