                    ...
                    <div className="flex items-center justify-between p-6 border-b border-[var(--border)] bg-[var(--background)] shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-0.5">
                                <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Runtime Diagnostics</span>
                                <div className="flex items-center gap-3">
                                    <h3 className="text-[11px] font-bold tracking-tight text-[var(--foreground)]">Build Logs</h3>
