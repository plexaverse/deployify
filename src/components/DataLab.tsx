                        ...
                        <tr className="bg-[var(--muted)]/20 border-b border-[var(--border)]">
                            {columns.map(col => (
                                <th
                                    ...
                                    className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] whitespace-nowrap cursor-pointer hover:text-[var(--primary)] transition-colors group"
                                >
                        ...
                        {paginatedResults.map((row, i) => (
                            <tr key={i} className="border-b border-[var(--border)] last:border-0 hover:bg-[var(--muted)]/5 transition-colors group/row">
                                {columns.map(col => {
                                    ...
                                    return (
                                        <td key={col} className="p-3 text-[7px] font-mono whitespace-nowrap max-w-[200px] truncate group/cell relative">
                                            <div className="flex items-center gap-1.5">
                                                {value}
                                                {fkInfo && (
                                                    <button
                                        ...
                                        {aggregations[col] ? (
                                            <div className="space-y-1">
                                                <div className="flex items-center justify-between gap-4">
                                                    <span className="text-[7px] font-bold text-[var(--muted-foreground)] uppercase">SUM</span>
                                                    <span className="text-[7px] font-mono font-bold text-[var(--primary)]">{aggregations[col].sum.toLocaleString()}</span>
                                                </div>
                                                <div className="flex items-center justify-between gap-4">
                                                    <span className="text-[7px] font-bold text-[var(--muted-foreground)] uppercase">AVG</span>
                                                    <span className="text-[7px] font-mono font-bold text-[var(--primary)]">{aggregations[col].avg.toFixed(2)}</span>
                                                </div>
                                                <div className="flex items-center justify-between gap-4">
                                                    <span className="text-[7px] font-bold text-[var(--muted-foreground)] uppercase">MIN/MAX</span>
                                                    <span className="text-[7px] font-mono font-bold text-[var(--primary)]">{aggregations[col].min} / {aggregations[col].max}</span>
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="h-4" />
            ...
            <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-1.5">
                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">X-Axis (Labels)</Label>
                        <select
                            value={chartConfig.xAxis}
                            onChange={(e) => setChartConfig(prev => ({ ...prev, xAxis: e.target.value }))}
                            className="w-full h-8 px-2 rounded bg-[var(--muted)]/20 border border-[var(--border)] text-[7px] font-bold uppercase"
                        >
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Y-Axis (Numeric)</Label>
                        <select
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Chart Type</Label>
                            ...
                            {(['bar', 'line', 'area', 'pie'] as const).map(t => (
                                <Button
                                    ...
                                    onClick={() => setChartConfig(prev => ({ ...prev, type: t }))}
                                        className={`flex-1 h-full text-[7px] font-bold uppercase tracking-wider px-1 ${chartConfig.type === t ? 'bg-[var(--background)] shadow-sm text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`}
                                >
                                    {t}
                                </Button>
                            ))}
                ...
                {!chartConfig.xAxis || !chartConfig.yAxis ? (
                    <div className="flex flex-col items-center justify-center py-8 space-y-4 border border-dashed border-[var(--border)] rounded-2xl bg-[var(--muted)]/5">
                        ...
                        <div className="text-center space-y-1">
                            <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Configure axes to visualize data</p>
                            <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">Select X and Y axes from the results</p>
                        </div>
                    </div>
                ) : (
        ...
        <Card className="overflow-hidden p-0 border-[var(--primary)]/20 shadow-xl shadow-[var(--primary)]/5">
            <div className="p-6 flex items-center justify-between bg-[var(--primary)]/5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Data Lab</span>
                        <h3 className="text-[9px] font-bold">Managed Query Browser</h3>
                    </div>
                </div>
                    ...
                    {performanceData && (
                        <>
                            <div className="text-right hidden md:block">
                                <span className="block text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Avg Latency</span>
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">{performanceData.avgLatency}ms</span>
                            </div>
                            <div className="text-right hidden md:block">
                                <span className="block text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Success Rate</span>
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--success)]">{performanceData.successRate}%</span>
                            </div>
                        </>
                    )}
                    <Button
                        ...
                        className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider ${showInsights ? 'bg-[var(--primary)]/10 text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`}
                    >
            ...
            <div className="px-6 py-2 bg-[var(--muted)]/5 border-b border-[var(--border)] flex items-center gap-4">
                <Button
                    ...
                    className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider rounded-none border-b-2 transition-all ${activeTab === 'editor' ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/5' : 'border-transparent text-[var(--muted-foreground)]'}`}
                >
                ...
                <Button
                    ...
                    className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider rounded-none border-b-2 transition-all ${activeTab === 'saved' ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/5' : 'border-transparent text-[var(--muted-foreground)]'}`}
                >
                ...
                <Button
                    ...
                    className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider rounded-none border-b-2 transition-all ${activeTab === 'history' ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/5' : 'border-transparent text-[var(--muted-foreground)]'}`}
                >
                ...
                <Button
                    ...
                    className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider rounded-none border-b-2 transition-all ${activeTab === 'dashboards' ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/5' : 'border-transparent text-[var(--muted-foreground)]'}`}
                >
                ...
                {userRole !== 'viewer' && (
                    <Button
                        ...
                        className={`h-8 px-3 text-[7px] font-bold uppercase tracking-wider rounded-none border-b-2 transition-all ${activeTab === 'audit' ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--primary)]/5' : 'border-transparent text-[var(--muted-foreground)]'}`}
                    >
            ...
            <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4 animate-fade-in">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Compliance Monitoring</span>
                                    <h3 className="text-[9px] font-bold">Query Audit Logs</h3>
                                </div>
                            </div>
                            <Button
                                variant="ghost"
                                ...
                                className="h-8 px-3 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] hover:bg-[var(--primary)]/10"
                            >
                        ...
                        <div className="overflow-x-auto rounded-xl border border-[var(--border)] bg-[var(--background)]">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-[var(--muted)]/20 border-b border-[var(--border)]">
                                        <th className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Timestamp</th>
                                        <th className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">User</th>
                                        <th className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Query</th>
                                        <th className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Status</th>
                                        <th className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] text-right">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {auditLogs.length === 0 ? (
                                        <tr>
                                            <td colSpan={5} className="p-8 text-center">
                                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">No audit logs found</span>
                                            </td>
                                        </tr>
                                    ) : (
                                        auditLogs.map((log) => (
                                            <tr key={log.id} className="border-b border-[var(--border)] last:border-0 hover:bg-[var(--muted)]/5 transition-colors">
                                                <td className="p-3 text-[7px] font-mono whitespace-nowrap">
                                                    {new Date(log.timestamp).toLocaleString()}
                                                </td>
                                                <td className="p-3 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">
                                                    {log.userEmail}
                                                </td>
                                                <td className="p-3 text-[7px] font-mono max-w-[300px] truncate">
                                                    {log.query}
                                                </td>
                                                <td className="p-3">
                                                    <span className={cn(
                                                ...
                                                <td className="p-3 text-right">
                                                    <Button
                                                        ...
                                                        className="h-7 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--primary)]"
                                                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                        <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Select Connector</Label>
                        <select
                            value={selectedId}
                            onChange={(e) => setSelectedId(e.target.value)}
                                    className="w-full h-10 px-3 rounded-lg bg-[var(--muted)]/20 border border-[var(--border)] text-[7px] font-bold uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50"
                        >
                            {connectors.map(c => (
                    ...
                    <div className="md:col-span-2 space-y-2">
                        <div className="flex items-center justify-between">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                {selectedConnector?.type.includes('sql') || selectedConnector?.type === 'planetscale' ? 'SQL Query (Read-Only)' : 'NoSQL Filter / JSON'}
                            </Label>
                            <Button
                                variant="ghost"
                                size="sm"
                                className="h-6 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]"
                            ...
                            <div className="relative space-y-4">
                                ...
                                <div className="relative">
                                    <Button
                                        ...
                                        className={cn(
                                            "h-10 px-4 text-[7px] font-bold uppercase tracking-wider transition-colors",
                                    ...
                                    {showTemplates && (
                                        <div className="absolute bottom-full mb-2 right-0 w-64 bg-[var(--popover)] border border-[var(--border)] rounded-xl shadow-2xl p-2 z-50 animate-in slide-in-from-bottom-2 fade-in">
                                            <div className="p-2 border-b border-[var(--border)] mb-1">
                                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">QUICK TEMPLATES</span>
                                            </div>
                                            <div className="space-y-1">
                                                {templates.map(t => (
                                                    <button
                                                    ...
                                                    >
                                                        <span className="block text-[7px] font-bold uppercase tracking-wider group-hover:text-[var(--primary)]">{t.name}</span>
                                                        <code className="block text-[7px] font-mono text-[var(--muted-foreground)] truncate">{t.query}</code>
                                                    </button>
                                                ))}
                                                {templates.length === 0 && (
                                                    <div className="p-4 text-center">
                                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">NO TEMPLATES AVAILABLE</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                ...
                                <Button
                                    ...
                                    onClick={formatQuery}
                                    disabled={!query.trim()}
                                    className="h-10 px-4 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--primary)] hover:bg-[var(--primary)]/10"
                                    title="Format Query"
                                >
                                ...
                                {detectedVars.length > 0 && (
                                    <div className="p-4 rounded-xl border border-[var(--border)] bg-[var(--muted)]/5 animate-in slide-in-from-top-2">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Query Variables</span>
                                        </div>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                            {detectedVars.map(v => (
                                                <div key={v} className="space-y-1.5">
                                                    <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/70">:{v}</Label>
                                                    <Input
                                                        value={queryVariables[v] || ''}
                                                        onChange={(e) => setQueryVariables(prev => ({ ...prev, [v]: e.target.value }))}
                                                        placeholder={`VALUE FOR :${v.toUpperCase()}`}
                                                        className="h-8 text-[7px] font-mono placeholder:text-[7px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider"
                                                    />
                                                </div>
                                            ))}
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 animate-fade-in">
                        {savedQueries.length === 0 ? (
                            <div className="col-span-full py-8 text-center space-y-4 border border-dashed border-[var(--border)] rounded-2xl bg-[var(--muted)]/5">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">No saved queries yet</p>
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">Save frequently used queries for quick access</p>
                                </div>
                            </div>
                        ) : (
                            savedQueries.map(q => (
                                <Card key={q.id} className="p-4 bg-[var(--background)] border-[var(--border)] hover:border-[var(--primary)]/30 transition-all group">
                                    <div className="flex items-start justify-between mb-3">
                                        ...
                                        <div className="w-7 h-7 rounded-lg bg-[var(--primary)]/10 flex items-center justify-center">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-[7px] font-bold uppercase tracking-wider truncate max-w-[150px]">{q.name}</span>
                                                {q.isPublic && <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--success)]">Team Shared</span>}
                                            </div>
                                        </div>
                                    ...
                                    <pre className="text-[7px] font-mono bg-[var(--muted)]/20 p-2 rounded mb-3 max-h-20 overflow-hidden line-clamp-3 text-[var(--muted-foreground)]">
                                        {q.query}
                                    </pre>
                                    <div className="flex gap-2">
                                        <Button
                                            ...
                                            className="flex-1 h-8 text-[7px] font-bold uppercase tracking-wider border-[var(--primary)]/20 text-[var(--primary)] hover:bg-[var(--primary)]/10"
                                        >
                                            ...
                                            <div className="max-h-40 overflow-y-auto space-y-2 custom-scrollbar pr-2">
                                                {(comments[q.id] || []).map(c => (
                                                    <div key={c.id} className="p-2 rounded bg-[var(--muted)]/10 border border-[var(--border)] space-y-1">
                                                        <div className="flex items-center justify-between">
                                                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">{c.userName}</span>
                                                            <span className="text-[7px] text-[var(--muted-foreground)]/60">{new Date(c.createdAt).toLocaleDateString()}</span>
                                                        </div>
                                                        <p className="text-[7px] text-[var(--foreground)]">{c.text}</p>
                                                    </div>
                                                ))}
                                                {(!comments[q.id] || comments[q.id].length === 0) && (
                                                    <div className="text-center py-2">
                                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/40">No comments yet</span>
                                                    </div>
                                                )}
                                            </div>
                                            <div className="flex gap-2">
                                                <Input
                                                    ...
                                                    className="h-8 text-[7px] font-bold uppercase tracking-wider placeholder:text-[7px]"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in">
                        {dashboards.length === 0 ? (
                            <div className="col-span-full py-12 text-center space-y-4 border border-dashed border-[var(--border)] rounded-2xl bg-[var(--muted)]/5">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">No dashboard widgets yet</p>
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">Add query results or charts to your dashboard for quick visualization</p>
                                </div>
                            </div>
                        ) : (
                                        ...
                                        <div className="p-4 border-b border-[var(--border)] flex items-center justify-between bg-[var(--muted)]/5">
                                            <div className="flex items-center gap-2 overflow-hidden mr-2">
                                                ...
                                                <div className="flex flex-col min-w-0">
                                                    <span className="text-[7px] font-bold uppercase tracking-wider truncate">{widget.name}</span>
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60 truncate">{widgetConnector?.name || 'UNKNOWN STORAGE'}</span>
                                                        {widget.isPublic && (
                                                            <span className="text-[7px] font-bold uppercase text-[var(--success)] shrink-0">Shared</span>
                                                        )}
                                                        {widget.refreshInterval && widget.refreshInterval > 0 && (
                                                            <span className="text-[7px] font-bold uppercase text-[var(--primary)] shrink-0 flex items-center">
                                            ...
                                            <div className="flex items-center gap-1 shrink-0">
                                                <select
                                                    ...
                                                    className="h-6 px-1 rounded bg-[var(--muted)]/20 border border-[var(--border)] text-[7px] font-bold uppercase tracking-wider"
                    ...
                    <div className="space-y-2 animate-fade-in">
                        {history.length === 0 ? (
                            <div className="py-8 text-center space-y-4 border border-dashed border-[var(--border)] rounded-2xl bg-[var(--muted)]/5">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Query history is empty</p>
                                    <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/50">Your recently executed queries will appear here</p>
                                </div>
                            </div>
                        ) : (
                                    ...
                                    >
                                        <div className="flex items-center gap-4 flex-1">
                                            ...
                                            <div className="space-y-1 flex-1">
                                                <div className="flex items-center gap-3">
                                                    <code className="text-[7px] font-mono text-[var(--foreground)] line-clamp-1">{h.query}</code>
                                                    {h.error && <span className="text-[7px] font-bold uppercase bg-[var(--error)]/10 text-[var(--error)] px-1 rounded">Error</span>}
                                                </div>
                                                <div className="flex items-center gap-3">
                                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]/60">
                                                        {new Date(h.timestamp).toLocaleString()}
                                                    </span>
                                                    {h.executionTimeMs !== undefined && (
                                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]/60">
                                                            {h.executionTimeMs}ms
                                                        </span>
                                                    )}
                                                    {h.rowCount !== undefined && (
                                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--success)]/60">
                                                            {h.rowCount} rows
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        <Button
                                            ...
                                            className="h-8 px-3 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] opacity-0 group-hover:opacity-100 transition-opacity"
                                        >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="md:col-span-1 space-y-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Historical Performance</span>
                            </div>
                            <div className="space-y-3">
                                <div>
                                    <span className="block text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Uptime / Success</span>
                                    <span className="text-[9px] font-bold text-[var(--success)]">{performanceData.successRate}%</span>
                                </div>
                                <div>
                                    <span className="block text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Avg Execution</span>
                                    <span className="text-[9px] font-bold text-[var(--primary)]">{performanceData.avgLatency}ms</span>
                                </div>
                                <div>
                                    <span className="block text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Queries (Last 100)</span>
                                    <span className="text-[9px] font-bold text-[var(--foreground)]">{performanceData.totalQueries}</span>
                                </div>
                            </div>
                        </div>
                        <div className="md:col-span-3 space-y-4">
                            <div className="flex items-center justify-between">
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Response Time Trend</span>
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--muted)]/20 px-1.5 py-0.5 rounded">Last 7 Days</span>
                            </div>
                            <div className="h-24 flex items-end gap-1.5">
                                {(performanceData.timeseries || []).map((day, i) => (
                                    <div key={i} className="flex-1 group relative">
                                        ...
                                        />
                                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[var(--popover)] text-[7px] font-bold px-2 py-1 rounded shadow-lg border border-[var(--border)] opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                                ...
                                {(!performanceData.timeseries || performanceData.timeseries.length === 0) && (
                                    <div className="w-full h-full flex items-center justify-center border border-dashed border-[var(--border)] rounded-lg">
                                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Insufficient Data</span>
                                    </div>
                                )}
                            </div>
                            <div className="flex justify-between">
                                {(performanceData.timeseries || []).map((day, i) => (
                                    <span key={i} className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">
                      ...
                      {performanceData.hotspots && performanceData.hotspots.length > 0 && (
                          <div className="pt-4 border-t border-[var(--primary)]/10 space-y-3">
                              <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--error)]">Performance Hotspots (Slow Queries)</span>
                              </div>
                                  ...
                                  {performanceData.hotspots.map((h, i) => (
                                      <div key={i} className="p-2 rounded bg-[var(--background)] border border-[var(--border)] flex items-center justify-between group">
                                          <div className="flex items-center gap-3 overflow-hidden">
                                              <span className="text-[7px] font-bold text-[var(--muted-foreground)] bg-[var(--muted)]/20 px-1.5 py-0.5 rounded shrink-0">{h.count}X</span>
                                              <code className="text-[7px] font-mono truncate text-[var(--foreground)]">{h.query}</code>
                                          </div>
                                          <div className="flex items-center gap-3 shrink-0">
                                              <span className="text-[7px] font-bold text-[var(--error)]">{h.avgLatency}ms</span>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => {
                                                  ...
                                                  className="h-6 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] opacity-0 group-hover:opacity-100 transition-opacity"
                                              >
                                                  Optimize
                                              </Button>
                                          </div>
                ...
                {schema && (
                    <div className="p-4 rounded-xl bg-[var(--primary)]/5 border border-[var(--primary)]/20 animate-fade-in">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Schema Insight</span>
                                </div>
                                <div className="flex items-center gap-1 bg-[var(--muted)]/20 p-0.5 rounded-lg border border-[var(--border)]">
                                    <Button
                                        ...
                                        className="h-6 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] hover:bg-[var(--primary)]/10"
                                    >
                                    ...
                                    <Button
                                        ...
                                        className={cn(
                                            "h-6 px-2 text-[7px] font-bold uppercase tracking-wider",
                            ...
                            {schema.columns && (
                                <Button
                                    ...
                                    className="h-6 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] hover:bg-[var(--primary)]/10"
                                >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Entities</span>
                                    <div className="relative w-48">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-7 pl-7 pr-2 rounded bg-[var(--background)] border border-[var(--border)] text-[7px] font-bold uppercase tracking-wider focus:outline-none focus:ring-1 focus:ring-[var(--primary)]/50 placeholder:text-[var(--muted-foreground)]/50"
                                        />
                                    </div>
                                </div>
                                    ...
                                    {selectedConnector?.type === 'memorystore-redis' && (schema as { sampleKeys?: string[] })?.sampleKeys ? (
                                        ...
                                        (schema.tables || schema.collections || []).filter(item => item.toLowerCase().includes(entitySearchQuery.toLowerCase())).map(item => (
                                            <button
                                                ...
                                                className="px-2 py-1 rounded bg-[var(--background)] border border-[var(--border)] text-[7px] font-mono hover:border-[var(--primary)] transition-colors flex items-center gap-2 group"
                                            >
                                                <div className="flex items-center gap-2">
                                                    <span>{item}</span>
                                                    {schema.tableStats?.[item] !== undefined && (
                                                        <span className="text-[7px] font-bold text-[var(--muted-foreground)]/50 uppercase tracking-wider">
                            ...
                            {schema.columns && Object.keys(schema.columns).length > 0 && (
                                <div className="space-y-3 border-l border-[var(--border)] pl-4">
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Structure Preview</span>
                                            ...
                                            <div key={table} className="space-y-1.5 p-2 rounded-xl border border-[var(--border)] bg-[var(--muted)]/5 group/table-item">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[7px] font-bold uppercase tracking-wider">{table}</span>
                                                    </div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-transparent border-none text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] placeholder:text-[7px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider placeholder:text-[var(--muted-foreground)]/30 focus:outline-none focus:ring-0 p-0 h-4 pl-5"
                                                />
                                                        ...
                                                        <div key={c.name} className="flex flex-col gap-1 p-2 rounded bg-[var(--muted)]/20 border border-[var(--border)] group/col-item relative">
                                                            <div className="flex items-center justify-between gap-4">
                                                                <div className="flex items-center gap-1">
                                                                    <span className="text-[7px] font-mono font-bold">{c.name}</span>
                                                                    {c.isPrimary && <span className="text-[7px] font-bold text-[var(--primary)] mr-0.5">PK</span>}
                                                                    {c.isForeign && <span className="text-[7px] font-bold text-[var(--success)] mr-0.5">FK</span>}
                                                                    {c.indices && c.indices.map(idx => (
                                                                        <span key={idx} className="text-[7px] font-bold text-[var(--warning)] mr-0.5" title={idx}>IDX</span>
                                                                    ))}
                                                                    <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)] opacity-60">{c.type}</span>
                                                                </div>
                                                                <div className="flex items-center gap-1">
                                                            ...
                                                            <div className="relative group/doc">
                                                                <input
                                                                    ...
                                                                    className="w-full bg-transparent border-none text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] placeholder:text-[7px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider placeholder:text-[var(--muted-foreground)]/30 focus:outline-none focus:ring-0 p-0 h-4"
                                                                />
                ...
                {error && (
                    <div className="p-4 rounded-lg bg-[var(--error)]/10 border border-[var(--error)]/20 flex items-start gap-3 text-[var(--error)]">
                        ...
                        <span className="text-[7px] font-bold uppercase tracking-wider">{error}</span>
                    </div>
                )}
                    ...
                    <div className="space-y-3 animate-fade-in">
                        <div className="p-3 border border-[var(--border)] rounded-xl bg-[var(--muted)]/5 flex items-center gap-3">
                            ...
                            <Input
                                ...
                                className="h-8 border-none bg-transparent focus-visible:ring-0 text-[7px] font-bold uppercase tracking-wider placeholder:text-[7px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider"
                            />
                            {filterQuery && (
                                <Button
                                    variant="ghost"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-1 bg-[var(--muted)]/20 p-1 rounded-xl border border-[var(--border)] mr-2">
                                        {resultSets.map((_, idx) => (
                                            <Button
                                                ...
                                                className={cn(
                                                    "h-7 px-3 text-[7px] font-bold uppercase tracking-wider",
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center gap-2 text-[7px] font-bold uppercase tracking-wider text-[var(--success)]">
                                ...
                                <div className="flex items-center gap-1">
                                    <div className="flex items-center bg-[var(--muted)]/20 rounded-lg p-0.5 border border-[var(--border)] mr-2">
                                        <Button
                                            ...
                                            className="h-5 px-1.5 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--primary)]"
                                    ...
                                    <Button
                                        ...
                                        size="sm"
                                        onClick={downloadCSV}
                                        className="h-6 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--primary)]"
                                    >
                                    ...
                                    <Button
                                        ...
                                        className="h-6 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--error)] hover:bg-[var(--error)]/10"
                                    >
                            ...
                            <div className="flex items-center gap-1 bg-[var(--muted)]/20 p-1 rounded-lg border border-[var(--border)]">
                                <Button
                                    ...
                                    className={`h-7 px-3 text-[7px] font-bold uppercase tracking-wider ${viewMode === 'table' ? 'bg-[var(--background)] shadow-sm text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`}
                                >
                                ...
                                <Button
                                    ...
                                    className={`h-7 px-3 text-[7px] font-bold uppercase tracking-wider ${viewMode === 'json' ? 'bg-[var(--background)] shadow-sm text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`}
                                >
                                    <Terminal className="w-3.5 h-3.5 mr-1.5" />
                                    JSON
                                </Button>
                                <Button
                                    ...
                                    className={`h-7 px-3 text-[7px] font-bold uppercase tracking-wider ${viewMode === 'chart' ? 'bg-[var(--background)] shadow-sm text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`}
                                >
                        ...
                        {optimizationSuggestions && (
                            <div className="p-4 rounded-xl bg-[var(--primary)]/5 border border-[var(--primary)]/20 animate-in slide-in-from-top-2 mb-4">
                                <div className="flex items-center gap-2 mb-3">
                                    <TrendingUp className="w-4 h-4 text-[var(--primary)]" />
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--primary)]">Optimization Suggestions (Virtual DBA)</span>
                                </div>
                                <div className="space-y-2">
                                    {optimizationSuggestions.map((s, i) => (
                                        <div key={i} className="flex items-start gap-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--background)] p-2 rounded border border-[var(--border)]">
                        ...
                        <div className="min-h-[300px] max-h-[600px] overflow-auto">
                            {viewMode === 'chart' ? (
                                        ...
                                        <div className="mt-4 flex items-center justify-between px-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    ...
                                                    className="h-7 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]"
                                                >
                                ...
                                <div className="rounded-xl border border-[var(--border)] bg-[var(--muted)]/10 p-4">
                                    <pre className="text-[7px] font-mono text-[var(--foreground)]">
                    ...
                    <Card className="w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="p-6 border-b border-[var(--border)] flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[9px] font-bold">Audit Query Source</h3>
                            </div>
                        ...
                        <div className="p-6">
                            <div className="p-4 bg-black/40 border border-[var(--border)] rounded-xl font-mono text-[7px] max-h-96 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="p-6 bg-[var(--muted)]/5 border-t border-[var(--border)] flex justify-end gap-3">
                            ...
                            <Button
                                ...
                                className="text-[7px] font-bold uppercase tracking-wider bg-[var(--primary)]"
                            >
                    ...
                    <Card className="w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="p-6 border-b border-[var(--border)] flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[9px] font-bold">{isCloning ? 'Clone Query' : 'Save Query'}</h3>
                            </div>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="space-y-2">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Query Name</Label>
                                <Input
                                    value={newQueryName}
                            ...
                            <div className="flex items-center justify-between p-3 border border-[var(--border)] rounded-xl bg-[var(--muted)]/5">
                                <div className="space-y-0.5">
                                    <Label className="text-[7px] font-bold uppercase tracking-wider">Share with Team</Label>
                                    <p className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">Allow other team members to use this query</p>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="space-y-2">
                                <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">SQL/JSON Code</Label>
                                <pre className="p-3 bg-[var(--muted)]/20 rounded-xl text-[7px] font-mono line-clamp-4 text-[var(--muted-foreground)]">
                                    {query}
                                </pre>
                            </div>
                        </div>
    ...
    if (isExecuting) {
        return (
            <div className="h-full flex flex-col items-center justify-center space-y-3">
                ...
                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Executing Query...</span>
            </div>
        );
    }
        ...
        <div className="overflow-x-auto rounded-lg border border-[var(--border)] h-full">
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="bg-[var(--muted)]/20 border-b border-[var(--border)]">
                        {columns.map(col => (
                            <th key={col} className="p-2 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                {col}
                            </th>
                        ))}
                    </tr>
                ...
                <tbody>
                    {results.slice(0, 5).map((row, i) => (
                        <tr key={i} className="border-b border-[var(--border)] last:border-0">
                            {columns.map(col => (
                                <td key={col} className="p-2 text-[7px] font-mono truncate max-w-[120px]">
            ...
            {results.length > 5 && (
                <div className="p-2 text-center border-t border-[var(--border)]">
                    <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]/60">
