...
useEffect(() => {
    ...
    return (
        <div className={cn(
            "relative flex rounded-xl bg-[var(--background)] border border-[var(--border)] font-mono text-[11px] focus-within:ring-2 focus-within:ring-[var(--primary)]/50 overflow-hidden",
            className
        )}>
            {showSuggestions && (
                <div
                ...
                >
                    {filteredSuggestions.map((s, i) => (
                        <button
                            ...
                            className={cn(
                                "w-full text-left px-3 py-1.5 text-[9px] font-bold uppercase tracking-wider transition-colors",
            ...
            <div
                ref={lineNumbersRef}
                className="w-10 bg-[var(--muted)]/20 border-r border-[var(--border)] py-4 text-right pr-2 text-[9px] font-bold text-[var(--muted-foreground)]/40 select-none overflow-hidden"
            >
            ...
            <div
                ref={mirrorRef}
                className="absolute invisible whitespace-pre p-4 font-mono text-[11px] leading-5"
