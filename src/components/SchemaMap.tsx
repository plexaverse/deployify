                    ...
                    return (
                        <g key={table} transform={`translate(${node.x}, ${node.y})`} className="cursor-pointer group" onClick={() => onTableClick(table)}>
                            ...
                            <text
                                x="25"
                                y="20"
                                className="text-[7px] font-bold uppercase tracking-wider fill-[var(--foreground)]"
                            >
                            ...
                            {columns[table]?.map((col, i) => (
                                <g key={col.name} transform={`translate(0, ${45 + i * 20})`}>
                                    ...
                                    <text
                                        ...
                                        y="0"
                                        textAnchor="end"
                                        className="text-[7px] fill-[var(--muted-foreground)] opacity-50 uppercase font-bold tracking-wider"
                                    >
                                        {col.type}
                                    </text>
                                </g>
