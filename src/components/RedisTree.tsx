    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Redis Key Explorer</span>
            </div>
            <div className="pl-1">
    ...
    return (
        <div className="select-none">
            ...
            >
                ...
                {node.isKey && (
                    <span className="ml-auto opacity-0 group-hover:opacity-100 text-[10px] font-bold uppercase text-[var(--primary)] transition-opacity">
                        Fetch
                    </span>
                )}
            </div>
