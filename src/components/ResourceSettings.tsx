            ...
            <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label className="text-[10px] font-bold">CPU</Label>
                        <SegmentedControl
                    ...
                    <div className="space-y-2">
                        <Label className="text-[10px] font-bold">Memory</Label>
                        <SegmentedControl
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label htmlFor="min-instances" className="text-[10px] font-bold">Min Instances</Label>
                        <Input
                            id="min-instances"
                            type="number"
                            min="0"
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="max-instances" className="text-[10px] font-bold">Max Instances</Label>
                        <Input
                            id="max-instances"
                            type="number"
                            min="1"
