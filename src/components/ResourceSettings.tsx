        ...
        <Card className="overflow-hidden p-0">
            <div className="p-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <h3 className="text-[9px] font-bold">Compute Configuration</h3>
                </div>
            </div>
            ...
            <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label className="text-[9px] font-bold">CPU</Label>
                        <SegmentedControl
                    ...
                    <div className="space-y-2">
                        <Label className="text-[9px] font-bold">Memory</Label>
                        <SegmentedControl
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label htmlFor="min-instances" className="text-[9px] font-bold">Min Instances</Label>
                        <Input
                            id="min-instances"
                            type="number"
                            min="0"
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="max-instances" className="text-[9px] font-bold">Max Instances</Label>
                        <Input
                            id="max-instances"
                            type="number"
                            min="1"
