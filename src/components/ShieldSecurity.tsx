        ...
        <Card className="overflow-hidden border-[var(--primary)]/10 bg-gradient-to-br from-[var(--card)] to-[var(--muted)]/5">
            <div className="p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Deployify Edge</span>
                        <h3 className="text-[11px] font-bold">Shield Security</h3>
                    </div>
                </div>
                <Badge variant={wafEnabled ? "success" : "outline"} className="text-[9px] font-bold uppercase tracking-wider">
            ...
            <div className="p-6 pt-0 space-y-6">
                <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/10">
                    <div className="space-y-1">
                        <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/40">Global WAF</div>
                        <div className="text-[11px] font-bold">SQLi & XSS Protection</div>
                    </div>
                    <Switch
                        checked={wafEnabled}
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
                        ...
                        <div className="text-[11px] font-bold font-mono">{metrics?.blockedRequests || 0}</div>
                    ...
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
                        ...
                        <div className="text-[11px] font-bold font-mono">CDN</div>
                ...
                {metrics?.topThreats && metrics.topThreats.length > 0 && (
                    <div className="space-y-2">
                        <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/40 px-1">Top Mitigated Threats</div>
