    ...
    return (
        <Card className="overflow-hidden p-0">
            <div className="p-6 flex items-center gap-3">
                ...
                <div>
                    <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Automation</span>
                    <h3 className="text-[10px] font-bold">Branch Deployments</h3>
                </div>
            </div>
            ...
            <div className="p-6 space-y-6">
                <div className="flex gap-2">
                    <Input
                        ...
                        className="flex-1 placeholder:text-[8px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider"
                        onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                                e.preventDefault();
                                handleAddBranch();
                        ...
                        {branches.map((branch: string) => (
                            <div key={branch} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-[var(--background)] gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold font-mono text-[10px]">{branch}</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[8px] uppercase font-bold text-[var(--muted-foreground)] tracking-wider px-1">Target Environment</span>
                                        <SegmentedControl
                                            options={[
