    ...
    return (
        <Card className="p-6 bg-[var(--card)]/50 border-[var(--primary)]/10">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Regional Alignment</span>
            ...
            <div className="space-y-4">
                {mappings.length === 0 ? (
                    <div className="py-12 text-center border border-dashed border-[var(--border)] rounded-2xl opacity-40">
                        <span className="text-[10px] font-bold uppercase tracking-wider">No regional mapping data available</span>
                    </div>
                ) : (
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[10px] font-bold uppercase tracking-tight truncate max-w-[120px]">{m.projectName}</span>
                                            {m.aligned ? (
                                    ...
                                    <div className="flex items-center gap-3 relative">
                                        <div className="flex flex-col items-center gap-1 shrink-0">
                                            ...
                                            <span className="text-[10px] font-bold uppercase text-[var(--muted-foreground)]">{m.projectRegion}</span>
                                        </div>
                                        ...
                                        <div className="flex flex-col items-center gap-1 shrink-0">
                                            ...
                                            <span className="text-[10px] font-bold uppercase text-[var(--primary)]">{m.storageRegion}</span>
                                        </div>
                                    </div>
                                </div>

                                <div className="mt-4 pt-3 border-t border-[var(--border)] flex items-center justify-between">
                                    <span className="text-[10px] font-bold uppercase text-[var(--muted-foreground)]">{m.storageName}</span>
                                    <span className="text-[10px] font-mono text-[var(--muted-foreground)] opacity-50">{m.storageType.toUpperCase()}</span>
                                </div>
                            </div>
                        ))}
                    </div>
