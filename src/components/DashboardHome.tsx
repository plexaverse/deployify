           ...
           {projects.map((project) => (
             ...
             >
               <BentoGridItem
                 ...
                 className="p-0 overflow-hidden border-0 bg-transparent shadow-none h-full min-h-[12rem] cursor-pointer transition-all duration-300 group-hover/card:scale-[0.99]"
               />
             </Link>
           ))}
        </BentoGrid>
