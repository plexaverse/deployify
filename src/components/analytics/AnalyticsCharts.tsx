        ...
        <Card className="overflow-hidden p-0 hover:border-[var(--primary)] hover:shadow-md transition-all duration-200 group">
            <div className="p-6">
                ...
                <div className="flex items-baseline gap-1">
                    <span className="text-sm font-semibold font-mono tracking-tight group-hover:text-[var(--primary)] transition-colors">
    ...
    return (
        <Card className="overflow-hidden p-0 hover:border-[var(--primary)] hover:shadow-md transition-all duration-300 group">
            <div className="p-6">
                ...
                <div className="mt-3 text-sm font-semibold font-mono tracking-tighter text-[var(--foreground)]">
                    {value}
                </div>
            </div>
        </Card>
