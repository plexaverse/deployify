    ...
    return (
        <div className="flex items-center gap-4 px-4 py-2 rounded-lg bg-[var(--card)] border border-[var(--border)] shadow-sm">
            <div className="flex items-center gap-2">
                ...
                <span className="text-[7px] font-bold uppercase tracking-wider whitespace-nowrap">
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] whitespace-nowrap">
            ...
            <div className="ml-auto flex items-center gap-1.5">
                ...
                <span className="text-[7px] font-bold text-[var(--success)] uppercase tracking-wider">Live</span>
            </div>
        </div>
    );
}
