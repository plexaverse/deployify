        ...
        return (
            <Card className="overflow-hidden p-0 border-dashed bg-[var(--muted)]/5">
                <div className="p-8 text-center flex flex-col items-center">
                     ...
                     <h3 className="text-xs font-bold mb-2 tracking-tight">No Deployment Metrics</h3>
            ...
            <Card className="overflow-hidden p-0">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-xs font-bold">Build Duration History</h3>
                    </div>
                </div>
            ...
            <Card className="overflow-hidden p-0">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="text-xs font-bold">Performance Score History</h3>
                    </div>
                </div>
                <Separator className="bg-[var(--border)]" />
                <div className="p-6">
