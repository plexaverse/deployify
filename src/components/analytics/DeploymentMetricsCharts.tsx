        ...
        return (
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-3 shadow-xl">
                ...
                {payload[0] && !!payload[0].payload.commit && (
                     <div className="mt-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] border-t border-[var(--border)] pt-2 max-w-[200px] truncate">
        ...
        return (
            <Card className="overflow-hidden p-0 border-dashed bg-[var(--muted)]/5">
                <div className="p-8 text-center flex flex-col items-center">
                     ...
                     <h3 className="text-[11px] font-bold mb-2 tracking-tight">No Deployment Metrics</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="overflow-hidden p-0">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Build Efficiency</span>
                        <h3 className="text-[11px] font-bold">Build Duration History</h3>
                    </div>
                </div>
            ...
            <Card className="overflow-hidden p-0">
                <div className="p-6 flex items-center gap-3">
                    ...
                    <div>
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Optimization Score</span>
                        <h3 className="text-[11px] font-bold">Performance Score History</h3>
                    </div>
                </div>
                <Separator className="bg-[var(--border)]" />
                <div className="p-6">
