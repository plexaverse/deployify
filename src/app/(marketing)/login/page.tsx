            ...
            <main id="main-content" className="w-full max-w-md relative z-10 flex flex-col items-center">
                ...
                <div className="p-8 flex flex-col items-center text-center">
                        ...
                        <div className="space-y-1 mb-8">
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Authentication</span>
                            <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Welcome back</h1>
                        </div>

                        <p className="text-[var(--muted-foreground)] text-[9px] mb-10">Sign in to manage your deployments</p>

                        <Link href="/api/auth/github" prefetch={false} className="w-full">
                            <MovingBorderButton
                                as="div"
                                containerClassName="w-full h-14"
                                className="bg-[var(--foreground)] text-[var(--background)] text-[7px] font-bold uppercase tracking-wider flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="relative w-full my-8">
                            ...
                            <div className="relative flex justify-center">
                                <span className="px-4 bg-[var(--card)] text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Secure OAuth 2.0</span>
                            </div>
                        </div>
                ...
                <p className="text-center mt-8">
                    <Link href="/" className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors">← Back to home</Link>
                </p>
            </main>
            <BackgroundBeams />
        </div>
