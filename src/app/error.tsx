        ...
        <Card className="overflow-hidden p-0 shadow-2xl border-[var(--error)]/30 backdrop-blur-xl bg-[var(--card)]/30">
            ...
            <div className="p-8 flex flex-col items-center text-center">
                ...
                <div className="space-y-1 mb-6">
                    ...
                    <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Something went wrong!</h1>
                </div>
                ...
                <div className="flex flex-col w-full gap-4">
                    <Button
                        size="lg"
                        onClick={() => reset()}
                        className="text-[7px] font-bold uppercase tracking-wider w-full"
                        variant="primary"
                    >
                ...
                <p className="mt-8 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] font-mono">
