                ...
                <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--error)]/30">
                    ...
                    <div className="p-8 flex flex-col items-center">
                        ...
                        <div className="space-y-1 mb-4">
                            ...
                            <h1 className="text-sm font-bold tracking-tight">Invite Error</h1>
                        </div>
            ...
            <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--primary)]/10">
                <div className="p-8 flex flex-col items-center">
                    <div className="mb-6 flex justify-center relative">
                        ...
                        <Avatar className="w-20 h-20 text-sm font-bold border-4 border-[var(--background)] relative z-10 shadow-lg rounded-2xl">
                    ...
                    <div className="space-y-1 mb-6">
                        ...
                        <h1 className="text-sm font-bold tracking-tight">Join {team.name}</h1>
                    </div>
