                ...
                <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--error)]/30">
                    ...
                    <div className="p-8 flex flex-col items-center">
                        ...
                        <div className="space-y-1 mb-4">
                            <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--error)]">Invalid Invite</span>
                            <h1 className="text-[8px] md:text-[10px] font-bold tracking-tight">Invite Error</h1>
                        </div>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-[var(--background)] relative overflow-hidden">
                ...
                <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--error)]/30">
                    ...
                    <div className="p-8 flex flex-col items-center">
                        ...
                        <div className="space-y-1 mb-4">
                            <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--error)]">Invite Expired</span>
                            <h1 className="text-[8px] md:text-[10px] font-bold tracking-tight">Invite Error</h1>
                        </div>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-[var(--background)] relative overflow-hidden">
                ...
                <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--error)]/30">
                    ...
                    <div className="p-8 flex flex-col items-center">
                        ...
                        <div className="space-y-1 mb-4">
                            <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--error)]">Team Not Found</span>
                            <h1 className="text-[8px] md:text-[10px] font-bold tracking-tight">Invite Error</h1>
                        </div>
            ...
            <Card className="max-w-md w-full text-center relative z-10 overflow-hidden p-0 shadow-2xl border-[var(--primary)]/10">
                <div className="p-8 flex flex-col items-center">
                    <div className="mb-6 flex justify-center relative">
                        ...
                        <Avatar className="w-20 h-20 text-[10px] font-bold border-4 border-[var(--background)] relative z-10 shadow-lg rounded-2xl">
                    ...
                    <div className="space-y-1 mb-6">
                        <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Team Invitation</span>
                        <h1 className="text-[8px] md:text-[10px] font-bold tracking-tight">Join {team.name}</h1>
                    </div>

                        <p className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] mb-8 leading-relaxed">
