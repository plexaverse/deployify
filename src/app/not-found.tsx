        ...
        <Card className="overflow-hidden p-0 shadow-2xl border-[var(--border)] backdrop-blur-xl bg-[var(--card)]/30">
            <div className="p-8 flex flex-col items-center text-center">
                ...
                <div className="space-y-1 mb-6">
                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">404 Error</span>
                    <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Page Not Found</h1>
                </div>
                <p className="text-[var(--muted-foreground)] text-[9px] mb-8">
                    The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
                </p>
                <div className="flex flex-col w-full gap-4">
                    <Link href="/" className="w-full">
                        <Button size="lg" className="font-bold w-full text-[7px] uppercase tracking-wider" variant="outline">
