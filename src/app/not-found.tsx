        ...
        <Card className="overflow-hidden p-0 shadow-2xl border-[var(--border)] backdrop-blur-xl bg-[var(--card)]/30">
            <div className="p-8 flex flex-col items-center text-center">
                ...
                <div className="space-y-1 mb-6">
                    ...
                    <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">Page Not Found</h1>
                </div>
                ...
                <div className="flex flex-col w-full gap-4">
                    <Link href="/" className="w-full">
                        <Button size="lg" className="font-bold w-full text-[9px] uppercase tracking-wider" variant="outline">
