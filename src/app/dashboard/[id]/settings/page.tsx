        ...
        return (
            <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-[7px] md:text-[9px] font-bold">Project Not Found</h2>
                    ...
                    <Link href="/dashboard">
                        <Button variant="outline" className="text-[7px] font-bold uppercase tracking-wider">
                            Back to Dashboard
                        </Button>
                    </Link>
                </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Project Configuration</span>
                        <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Project Settings</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Build Settings</span>
                            <h3 className="text-[9px] font-bold">Configuration</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="framework" className="text-[9px] font-bold">Framework</Label>
                                <NativeSelect
                                    id="framework"
                                    value={framework}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="root-directory" className="text-[9px] font-bold">Root Directory</Label>
                                <Input
                                    id="root-directory"
                                    type="text"
                                    value={rootDirectory}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="build-command" className="text-[9px] font-bold">Build Command</Label>
                                <Input
                                    id="build-command"
                                    type="text"
                                    value={buildCommand}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="output-directory" className="text-[9px] font-bold">Output Directory</Label>
                                <Input
                                    id="output-directory"
                                    type="text"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="install-command" className="text-[9px] font-bold">Install Command</Label>
                                <Input
                                    id="install-command"
                                    type="text"
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Notifications</span>
                            <h3 className="text-[9px] font-bold">Alert Preferences</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="webhook-url" className="text-[9px] font-bold">Webhook URL</Label>
                            <Input
                                id="webhook-url"
                                type="text"
                                value={webhookUrl}
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Security</span>
                            <h3 className="text-[9px] font-bold">Safety & Protection</h3>
                        </div>
                    </div>
                ...
                <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                    ...
                    <div className="p-6">
                        ...
                        <div>
                            <p className="text-[9px] font-bold text-[var(--error)]">Delete Project</p>
                            <p className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
