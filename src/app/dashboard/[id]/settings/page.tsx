        ...
        return (
            <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-xs font-bold">Project Not Found</h2>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <h1 className="text-[11px] md:text-xs font-bold tracking-tight">Project Settings</h1>
                    </div>
                </div>
            </div>
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold">Configuration</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="framework" className="text-xs font-bold">Framework</Label>
                                <NativeSelect
                                    id="framework"
                                    value={framework}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="root-directory" className="text-xs font-bold">Root Directory</Label>
                                <Input
                                    id="root-directory"
                                    type="text"
                                    value={rootDirectory}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="build-command" className="text-xs font-bold">Build Command</Label>
                                <Input
                                    id="build-command"
                                    type="text"
                                    value={buildCommand}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="output-directory" className="text-xs font-bold">Output Directory</Label>
                                <Input
                                    id="output-directory"
                                    type="text"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="install-command" className="text-xs font-bold">Install Command</Label>
                                <Input
                                    id="install-command"
                                    type="text"
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold">Alert Preferences</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="webhook-url" className="text-xs font-bold">Webhook URL</Label>
                            <Input
                                id="webhook-url"
                                type="text"
                                value={webhookUrl}
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold">Safety & Protection</h3>
                        </div>
                    </div>
                ...
                <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold text-[var(--error)]">Critical Actions</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div>
                            <p className="text-xs font-bold text-[var(--error)]">Delete Project</p>
                            <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
