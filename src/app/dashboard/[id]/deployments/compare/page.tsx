            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <Card className="overflow-hidden p-0">
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            <label className="text-[10px] font-bold mb-3 block">Select Source</label>
                            <NativeSelect
                                value={baseId}
                        ...
                        {baseDeployment ? (
                            <DeploymentSummary deployment={baseDeployment} />
                             ...
                             <div className="h-48 flex items-center justify-center text-[var(--muted-foreground)] border border-dashed border-[var(--border)] rounded-lg text-[10px] font-bold">
                                Select a deployment
                            </div>
                        )}
                    </div>
                ...
                <Card className="overflow-hidden p-0">
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            <label className="text-[10px] font-bold mb-3 block">Select Target</label>
                            <NativeSelect
                                value={targetId}
