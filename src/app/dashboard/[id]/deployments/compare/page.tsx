    ...
    return (
        <div className="space-y-4">
            <div className="flex items-start justify-between">
                <div>
                    <h3 className="font-semibold text-lg">{deployment.gitCommitMessage}</h3>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="p-3 bg-[var(--muted)]/10 rounded-lg">
                    <div className="text-[var(--muted-foreground)] text-xs mb-1">Created</div>
                    <div className="font-medium">{new Date(deployment.createdAt).toLocaleDateString()}</div>
                </div>
                 <div className="p-3 bg-[var(--muted)]/10 rounded-lg">
                    <div className="text-[var(--muted-foreground)] text-xs mb-1">Environment</div>
...
function ComparisonRow({ label, baseValue, targetValue }: { label: string, baseValue: React.ReactNode, targetValue: React.ReactNode }) {
    return (
        <div className="grid grid-cols-3 p-4 items-center">
            ...
            <div className="text-sm font-mono">{baseValue}</div>
            <div className="text-sm font-mono flex items-center gap-2">
                {targetValue}
                <ArrowRight className="w-3 h-3 text-[var(--muted-foreground)] opacity-20 ml-auto" />
            </div>
        </div>
    );
}
