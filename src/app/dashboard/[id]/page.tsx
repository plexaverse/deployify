                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Project Overview</span>
                        ...
                        <h1 className="text-[8px] md:text-[10px] font-bold tracking-tight">{project.name}</h1>
                    </div>
                </div>
                        ...
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <h2 className="text-[8px] md:text-[10px] font-bold">Production</h2>
                                        <Badge variant="outline" className="text-[8px] font-bold uppercase tracking-wider py-0 px-1.5 bg-[var(--background)]">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Badge
                                    variant="success"
                                    className="text-[8px] py-0.5 px-2 font-bold tracking-wider uppercase shadow-[0_0_10px_var(--success-bg)]"
                                >
                                    Live
                                </Badge>
                            </div>
                        ...
                        <div className="p-8">
                            {project.productionUrl ? (
                                <div className="space-y-6">
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-3">
                                            <div className="space-y-1">
                                                <p className="text-[10px] font-bold tracking-tight text-[var(--foreground)] truncate max-w-md group cursor-pointer hover:text-[var(--primary)] transition-colors" onClick={() => window.open(project.productionUrl!, '_blank')}>
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                <div className="flex items-center gap-2 text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--background)] px-3 py-1 rounded-full border border-[var(--border)] w-fit">
                                                    <GitBranch className="w-3 h-3" />
                                                <span>Branch: <span className="text-[var(--foreground)] font-mono text-[8px] font-bold uppercase tracking-wider">{project.defaultBranch.toUpperCase()}</span></span>
                                                </div>
                                                <div className="flex items-center gap-2 text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--background)] px-3 py-1 rounded-full border border-[var(--border)] w-fit">
                                                    <Clock className="w-3 h-3" />
                                                    <span>Last Push: <span className="text-[var(--foreground)] text-[8px] font-bold uppercase tracking-wider">{formatDate(project.updatedAt)}</span></span>
                                                </div>
                                            </div>
                                        </div>
                                        <Button
                                    ...
                                    <div className="pt-6 flex items-center justify-between border-t border-[var(--border)]">
                                        <div className="flex items-center gap-6 text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                        ...
                                        <Link href={`/dashboard/${params.id}/deployments`}>
                                            <Button variant="ghost" size="sm" className="text-[8px] font-bold h-7 text-[var(--primary)] hover:bg-[var(--primary)]/5 uppercase tracking-wider">
                                                View All Deploys
                                            </Button>
                                        </Link>
                                    </div>
                                ...
                                <div className="py-12 text-center space-y-3">
                                    <p className="text-[var(--muted-foreground)] text-[8px] font-bold uppercase tracking-wider">
                        ...
                        <Card className="overflow-hidden p-0 shadow-sm border-[var(--primary)]/10">
                            <div className="p-6 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-[10px] font-bold">Storage Health</h3>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2">
                                    {project.storageConfigs.every(s => (s.metadata?.health as { status: string })?.status === 'healthy' || s.status === 'provisioning') ? (
                                        <Badge variant="success" className="text-[8px] font-bold uppercase tracking-wider py-0 px-1.5 shadow-[0_0_8px_var(--success-bg)]">Operational</Badge>
                                    ) : project.storageConfigs.some(s => (s.metadata?.health as { status: string })?.status === 'unhealthy' || s.status === 'error') ? (
                                        <Badge variant="destructive" className="text-[8px] font-bold uppercase tracking-wider py-0 px-1.5 shadow-[0_0_8px_var(--error-bg)]">Unhealthy</Badge>
                                    ) : project.storageConfigs.some(s => (s.metadata?.health as { status: string })?.status === 'degraded') ? (
                                        <Badge variant="warning" className="text-[8px] font-bold uppercase tracking-wider py-0 px-1.5 shadow-[0_0_8px_var(--warning-bg)]">Degraded</Badge>
                                    ) : (
                                        <Badge variant="outline" className="text-[8px] font-bold uppercase tracking-wider py-0 px-1.5">Checking...</Badge>
                                    )}
                                </div>
                            </div>
                            <Separator className="bg-[var(--border)]" />
                            <div className="p-4 space-y-3">
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-[8px] font-bold text-[var(--muted-foreground)] uppercase">Resource Connectivity</span>
                                    <span className="text-[8px] font-bold text-[var(--muted-foreground)] uppercase">
                                        ...
                                        <div key={storage.id} className="flex items-center justify-between p-2 rounded-lg bg-[var(--muted)]/5 border border-[var(--border)] group hover:border-[var(--primary)]/30 transition-colors">
                                            <div className="flex items-center gap-3 overflow-hidden">
                                                ...
                                                <div className="flex flex-col min-w-0">
                                                    <span className="text-[8px] font-bold uppercase truncate">{storage.name}</span>
                                                    <span className="text-[8px] font-bold uppercase text-[var(--muted-foreground)] truncate">{storage.type.replace(/-/g, ' ')}</span>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2 shrink-0">
                                                ...
                                                {status === 'degraded' && (
                                                    <span className="text-[8px] font-bold text-[var(--warning)] uppercase">Slow</span>
                                                )}
                                                {status === 'unhealthy' && (
                                                    <span className="text-[8px] font-bold text-[var(--error)] uppercase">Failed</span>
                                                )}
                                ...
                                {project.storageConfigs.length > 3 && (
                                    <Link href={`/dashboard/${project.id}/storage`} className="block text-center pt-1">
                                        <span className="text-[8px] font-bold uppercase text-[var(--primary)] hover:underline">
                        ...
                        <Card className="overflow-hidden p-0 shadow-sm">
                            <div className="p-6 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">24h Status</span>
                                        <h3 className="text-[10px] font-bold">Vitals</h3>
                                    </div>
                                </div>
                            ...
                            <div className="p-6 flex items-baseline gap-2">
                                ...
                                <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">events tracked</span>
                            </div>
                        </Card>
                    )}
                </div>
            ...
            <div className="space-y-6">
                {deployments.length === 0 ? (
                    <EmptyState
                        ...
                        description={
                            <span>
                                Push your code to <code className="px-1.5 py-0.5 rounded bg-[var(--muted)] border border-[var(--border)] font-mono text-[8px] font-bold uppercase tracking-wider">{project.defaultBranch.toUpperCase()}</code> to trigger your first deployment.
                                We&apos;ll build and deploy your application automatically.
                            </span>
                        }
                    >
                        <div className="flex items-center gap-4 text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--background)] px-4 py-2 rounded-lg border border-[var(--border)]">
                    ...
                    <Card className="overflow-hidden shadow-sm p-0">
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Git Activity</span>
                                    <h2 className="text-[8px] md:text-[10px] font-bold">Deployment History</h2>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--background)] px-2 py-1 rounded border border-[var(--border)]">
                        ...
                        {deployments.length > 5 && (
                            <div className="px-6 py-3 bg-[var(--card)] border-t border-[var(--border)] text-center">
                                <Link
                                    ...
                                    className="text-[8px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors"
                                >
