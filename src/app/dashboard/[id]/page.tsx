                        ...
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <h2 className="text-xs font-semibold">Production</h2>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-3">
                                            <div className="space-y-1">
                                                <p className="text-xs font-semibold tracking-tight text-[var(--foreground)] truncate max-w-md group cursor-pointer hover:text-[var(--primary)] transition-colors" onClick={() => window.open(project.productionUrl!, '_blank')}>
                            ...
                            <div className="p-6 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-xs font-semibold">Vitals</h3>
                                    </div>
                                </div>
                        ...
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-xs font-semibold">Deployment History</h2>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
