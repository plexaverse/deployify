            ...
            <div className="flex flex-col gap-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Global Fleet</span>
                            <h1 className="text-[7px] md:text-[9px] font-bold tracking-tight">Infrastructure Intelligence</h1>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-4 p-4 border border-[var(--primary)]/10 rounded-2xl bg-[var(--card)]/30">
                    <div className="flex items-center gap-2 px-2 mr-2 border-r border-[var(--primary)]/10">
                        ...
                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Fleet Filters</span>
                    </div>

                    <div className="flex items-center gap-4 flex-1">
                        <div className="space-y-1.5 min-w-[140px]">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] ml-1">Status</Label>
                            <NativeSelect
                                value={statusFilter}
                                onChange={(e) => setStatusFilter(e.target.value)}
                                className="h-8 text-[7px] uppercase font-bold"
                            >
                        ...
                        <div className="space-y-1.5 min-w-[160px]">
                            <Label className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] ml-1">Storage Type</Label>
                            <NativeSelect
                                value={typeFilter}
                        ...
                        <div className="flex items-center gap-3 ml-auto pr-2">
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <Label htmlFor="only-optimizable" className="text-[7px] font-bold uppercase tracking-wider cursor-pointer">
                                    Optimizable
                                </Label>
                            </div>
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-4 h-4 rounded border-[var(--primary)]/20 text-[var(--primary)] focus:ring-[var(--primary)]"
                                />
                                <Label htmlFor="only-dormant" className="text-[7px] font-bold uppercase tracking-wider cursor-pointer">
                                    Dormant
                                </Label>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <Label htmlFor="only-at-risk" className="text-[7px] font-bold uppercase tracking-wider cursor-pointer text-[var(--error)]">
                                    At Risk
                                </Label>
                            </div>
                            <Button
                                ...
                                className="h-7 text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--primary)]"
                            >
                                Reset
                            </Button>
                        </div>
                ...
                {[
                    ...
                    >
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">{stat.label}</span>
                        </div>
                        <div className="flex items-baseline justify-between gap-2">
                            <span className="text-[9px] font-bold">{loading ? '...' : stat.value}</span>
                            {'subValue' in stat && stat.subValue && !loading && (
                                <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--success)] animate-pulse truncate whitespace-nowrap">{stat.subValue}</span>
                            )}
                        </div>
                    </Card>
                ))}
            ...
            {loading ? (
                ...
                <div className="py-20 text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-[9px] font-bold">No Connectors Found</h2>
                                    ...
                                    <div className="p-5 h-full flex flex-col justify-between space-y-4">
                                        <div className="space-y-3">
                                            <div className="flex items-start justify-between">
                                                <div className="space-y-1">
                                                    <div className="flex items-center gap-2">
                                                        <h3 className="text-[9px] font-bold tracking-tight truncate max-w-[140px]">{connector.name}</h3>
                                                        <Badge variant={
                                                            status === 'healthy' ? 'success' :
                                                            status === 'degraded' ? 'warning' :
                                                            status === 'provisioning' ? 'secondary' : 'destructive'
                                                        } className="text-[7px] font-bold uppercase px-1.5 py-0.5 h-4">
                                                            {status}
                                                        </Badge>
                                                    </div>
                                                    <div className="flex items-center gap-1 text-[7px] font-bold uppercase text-[var(--muted-foreground)]">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="p-2 rounded-lg bg-[var(--muted)]/5 border border-[var(--border)]">
                                                    <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)] mb-1">Provider</span>
                                                    <span className="text-[7px] font-bold uppercase truncate block">{connector.type.replace(/-/g, ' ')}</span>
                                                </div>
                                                <div className="p-2 rounded-lg bg-[var(--muted)]/5 border border-[var(--border)]">
                                                    <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)] mb-1">Region</span>
                                                    <span className="text-[7px] font-bold uppercase truncate block">{(connector.region || (connector.metadata?.region as string) || 'GLOBAL').toUpperCase()}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="p-2 rounded-lg bg-[var(--muted)]/10 border border-[var(--primary)]/10 flex items-center justify-between col-span-2">
                                                    <div>
                                                        <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Resource Tier</span>
                                                        <span className="text-[7px] font-mono font-bold text-[var(--primary)]">
                                                ...
                                                <div className="p-2 rounded-lg bg-[var(--success-bg)]/5 border border-[var(--success)]/10 flex items-center justify-between col-span-2">
                                                    <div>
                                                        <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Monthly Est.</span>
                                                        <div className="flex items-center gap-1">
                                                            <DollarSign className="w-2.5 h-2.5 text-[var(--success)]" />
                                                            <span className="text-[7px] font-mono font-bold text-[var(--success)]">
                                                                {(() => {
                                            ...
                                            {!!connector.metadata?.provisioned && (
                                                <div className="flex items-center gap-4 pt-1">
                                                    <div className="flex items-center gap-1.5">
                                                        ...
                                                        <span className="text-[7px] font-mono font-bold">ACTV</span>
                                                    </div>
                                                    <div className="flex items-center gap-1.5">
                                                        <ShieldCheck className="w-3 h-3 text-[var(--success)]" />
                                                        <span className="text-[7px] font-mono font-bold">SEC</span>
                                                    </div>
                                                    {optimization && (
                                                        <div className="flex items-center gap-1.5 animate-pulse">
                                                            <Sparkles className="w-3 h-3 text-[var(--primary)]" />
                                                            <span className="text-[7px] font-bold uppercase text-[var(--primary)]">Opt</span>
                                                        </div>
                                                    )}
                                                    {connector.dormancy?.isDormant && (
                                                        <div className="flex items-center gap-1.5 text-[var(--muted-foreground)]">
                                                            <Moon className="w-3 h-3" />
                                                            <span className="text-[7px] font-bold uppercase">Idl</span>
                                                        </div>
                                                    )}
                                                    {(((connector.metadata?.security as Record<string, unknown>)?.risks as unknown[])?.length > 0) && (
                                                        <div className="flex items-center gap-1.5 text-[var(--error)]">
                                                            ...
                                                            <span className="text-[7px] font-bold uppercase">Risk</span>
                                                        </div>
                                                    )}
                                                    {(((connector.metadata?.security as Record<string, unknown>)?.score as number) >= 90) && (
                                                        <div className="flex items-center gap-1.5 text-[var(--success)]">
                                                            <ShieldCheck className="w-3 h-3" />
                                                            <span className="text-[7px] font-bold uppercase">Safe</span>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                                            ...
                                            <div className="flex items-center gap-3">
                                                {health?.latency && (
                                                    <div className="flex flex-col">
                                                        <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Latency</span>
                                                        <span className={cn(
                                                ...
                                                {health?.baselineLatency && (
                                                    <div className="flex flex-col">
                                                        <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Baseline</span>
                                                        <span className="text-[7px] font-mono font-bold opacity-60">{health.baselineLatency}ms</span>
                                                    </div>
                                                )}
                                            </div>
                                            <div className="text-right">
                                                <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Environment</span>
                                                <span className="text-[7px] font-bold uppercase">{connector.environment}</span>
                                            </div>
                                        </div>
                                    </div>
                                }
