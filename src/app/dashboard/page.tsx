                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-fade-in">
                        ...
                        <div className="p-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="space-y-0.5">
                                    <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Infrastructure Fleet</span>
                                    <h3 className="text-[9px] font-bold">Global Connectivity Health</h3>
                                </div>
                            </div>
                                ...
                                {loadingInfra ? (
                                    ...
                                    <>
                                        <div className="text-right">
                                            <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Global Uptime</span>
                                            <span className={cn(
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="text-center">
                                                <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Healthy</span>
                                                <span className="text-[7px] font-bold text-[var(--success)]">{infraHealth.summary.healthyConnectors}</span>
                                            </div>
                                            <div className="text-center">
                                                <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Slow</span>
                                                <span className="text-[7px] font-bold text-[var(--warning)]">{infraHealth.summary.degradedConnectors}</span>
                                            </div>
                                            <div className="text-center">
                                                <span className="block text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Failed</span>
                                                <span className="text-[7px] font-bold text-[var(--error)]">{infraHealth.summary.unhealthyConnectors}</span>
                                            </div>
                                        </div>
                                    <Separator orientation="vertical" className="h-8 bg-[var(--border)]" />
                                    <Link href="/dashboard/infrastructure">
                                        <Button variant="ghost" size="sm" className="h-8 px-2 text-[7px] font-bold uppercase tracking-wider text-[var(--primary)] hover:bg-[var(--primary)]/5">
                                            View Fleet
                                        </Button>
                                    </Link>
                                    </>
                    ...
                    <Card className="overflow-hidden p-4 border-[var(--primary)]/10 bg-[var(--primary)]/5 flex flex-col justify-center">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Active Resources</span>
                        </div>
                        <div className="flex items-baseline gap-2">
                            <span className="text-[9px] font-bold tracking-tighter">
                                {loadingInfra ? '...' : infraHealth?.summary.totalConnectors || 0}
                            </span>
                            <span className="text-[7px] font-bold uppercase text-[var(--muted-foreground)]">Managed Connectors</span>
                        </div>
                    </Card>
                </div>
            )}
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <span className="text-[7px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Workspace Overview</span>
                    ...
                    <div className="relative flex-1 md:w-64">
                        ...
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 z-10">
                            {searchQuery ? (
                                ...
                                <div className="hidden sm:flex items-center gap-0.5 text-[7px] font-bold uppercase tracking-wider text-[var(--muted)] border border-[var(--border)] rounded px-1.5 py-0.5 bg-[var(--background)]">
                                    <span>/</span>
                                </div>
                            )}
                        </div>
