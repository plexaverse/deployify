      ...
      <Card className="max-w-md w-full overflow-hidden p-0 bg-[var(--card)] border-[var(--border)] shadow-lg">
        <div className="p-8 flex flex-col items-center text-center">
            ...
            <div className="space-y-1 mb-6">
                <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">404 Error</span>
                <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">
                    Page Not Found
                </h1>
            </div>
            <p className="text-[var(--muted-foreground)] text-[9px] font-bold uppercase tracking-wider mb-8 max-w-[280px]">
                The resource you are looking for within the dashboard could not be found.
            </p>
            <Link href="/dashboard" className="w-full">
                <Button variant="outline" className="w-full h-12 text-[9px] font-bold uppercase tracking-wider">
