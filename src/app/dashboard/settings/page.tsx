                        ...
                        <Card className="overflow-hidden p-0">
                            ...
                            <form onSubmit={handleInvite} className="p-6 flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    <Label htmlFor="email" className="text-[10px] font-bold block mb-2">Email address</Label>
                                    <Input
                                        id="email"
                                        type="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <Label htmlFor="role" className="text-[10px] font-bold block mb-2 px-1">Role</Label>
                                    <SegmentedControl
                                        options={[
