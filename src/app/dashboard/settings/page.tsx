                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <h1 className="text-[11px] md:text-xs font-bold tracking-tight">Account Settings</h1>
                        </div>
                    </div>
                </div>
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold">Personal Profile</h3>
                        </div>
                    </div>
                ...
                <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                    ...
                    <div className="p-6">
                        <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                            <div>
                                <h3 className="text-xs font-bold text-[var(--error)]">Delete Account</h3>
                                <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <h1 className="text-[11px] md:text-xs font-bold tracking-tight">{activeTeam.name} Settings</h1>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                        ...
                        <Card className="overflow-hidden p-0">
                            <div className="p-6 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-xs font-bold">Invite New Member</h3>
                                </div>
                            </div>
                            <Separator className="bg-[var(--border)]" />
                            <form onSubmit={handleInvite} className="p-6 flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    <Label htmlFor="email" className="text-xs font-bold block mb-2">Email address</Label>
                                    <Input
                                        id="email"
                                        type="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <Label htmlFor="role" className="text-xs font-bold block mb-2 px-1">Role</Label>
                                    <SegmentedControl
                                        options={[
                        ...
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-xs font-bold">Team Members</h3>
                                </div>
                            </div>
                    ...
                    <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                                <div>
                                    <h3 className="text-xs font-bold">Leave Team</h3>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                            ...
                            {isOwner && (
                                <>
                                    ...
                                    <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                                        <div>
                                            <h3 className="text-xs font-bold text-[var(--error)]">Delete Team</h3>
                                            <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                    ...
                    <Card className="overflow-hidden p-0 h-full max-h-[800px] flex flex-col">
                        <div className="p-6 flex items-center gap-3 shrink-0">
                            ...
                            <div>
                                ...
                                <h3 className="text-xs font-bold">Audit Log</h3>
                            </div>
                        </div>
