            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Personal Workspace</span>
                            <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">Account Settings</h1>
                        </div>
                    </div>
                </div>
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Profile</span>
                            <h3 className="text-[11px] font-bold">Personal Profile</h3>
                        </div>
                    </div>
                    ...
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                <Button onClick={() => router.push('/billing')} variant="outline" size="sm" className="text-[9px] font-bold uppercase tracking-wider">
                                    Manage Billing
                                </Button>
                                <Link href="/api/auth/github" className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors flex items-center gap-1">
                ...
                <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                    ...
                    <div className="p-6">
                        <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                            <div>
                                <h3 className="text-[11px] font-bold text-[var(--error)]">Delete Account</h3>
                                <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Team Management</span>
                        <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">{activeTeam.name} Settings</h1>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {canManage && (
                        <Card className="overflow-hidden p-0">
                            <div className="p-6 flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Collaboration</span>
                                    <h3 className="text-[11px] font-bold">Invite New Member</h3>
                                </div>
                            </div>
                            <Separator className="bg-[var(--border)]" />
                            <form onSubmit={handleInvite} className="p-6 flex flex-col sm:flex-row gap-4">
                                <div className="flex-1">
                                    <Label htmlFor="email" className="text-[11px] font-bold block mb-2">Email address</Label>
                                    <Input
                                        id="email"
                                        type="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <Label htmlFor="role" className="text-[11px] font-bold block mb-2 px-1">Role</Label>
                                    <SegmentedControl
                                        options={[
                    ...
                    <Card className="overflow-hidden p-0">
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Team</span>
                                    <h3 className="text-[11px] font-bold">Team Members</h3>
                                </div>
                            </div>
                            <div className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] bg-[var(--muted)]/10 px-3 py-1 rounded-full border border-[var(--border)]">
                                        ...
                                        <div key={member.id} className="p-4 flex items-center justify-between hover:bg-[var(--card-hover)] transition-colors">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-bold text-[var(--foreground)] flex items-center gap-2">
                                                        ...
                                                        {member.role === 'owner' && <Badge variant="warning" className="text-[9px] px-1.5 py-0.5 font-bold uppercase tracking-wider">Owner</Badge>}
                                                    </p>
                                                    <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                                        {member.user?.email}
                                                    </p>
                                            ...
                                            <div className="flex items-center gap-4">
                                                {canManage && member.role !== 'owner' && member.userId !== activeTeam.membership.userId ? (
                                                    ...
                                                    <Badge variant={member.role === 'owner' ? 'success' : member.role === 'admin' ? 'info' : 'secondary'} className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5">
                                        ...
                                        <div key={invite.id} className="p-4 flex items-center justify-between bg-[var(--muted)]/5 hover:bg-[var(--card-hover)] transition-colors">
                                            <div className="flex items-center gap-3 opacity-75">
                                                ...
                                                <div>
                                                    <p className="font-bold text-[var(--foreground)] flex items-center gap-2">
                                                        {invite.email}
                                                        <Badge variant="info" className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0">Invited</Badge>
                                                    </p>
                                                    <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <Badge variant="secondary" className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5">{invite.role.toUpperCase()}</Badge>
                                                {canManage && (
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
                    ...
                    <Card className="border-[var(--error)]/30 bg-[var(--error)]/5 overflow-hidden p-0">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                                <div>
                                    <h3 className="text-[11px] font-bold">Leave Team</h3>
                                    <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                            ...
                            {isOwner && (
                                <>
                                    ...
                                    <div className="flex items-center justify-between p-4 border border-[var(--error)]/20 rounded-lg bg-[var(--background)]">
                                        <div>
                                            <h3 className="text-[11px] font-bold text-[var(--error)]">Delete Team</h3>
                                            <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                ...
                <div className="space-y-6">
                    <Card className="overflow-hidden p-0 h-full max-h-[800px] flex flex-col">
                        <div className="p-6 flex items-center gap-3 shrink-0">
                            ...
                            <div>
                                <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">System Activity</span>
                                <h3 className="text-[11px] font-bold">Audit Log</h3>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 pr-2 space-y-6 relative before:absolute before:left-[43px] before:top-6 before:bottom-6 before:w-[1px] before:bg-[var(--border)]">
                            {logs.length === 0 && !isLoading ? (
                                <div className="text-center text-[var(--muted-foreground)] text-[9px] font-bold uppercase tracking-wider py-8 pl-8">
                                ...
                                logs.map((log) => (
                                    <div key={log.id} className="relative pl-8">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] leading-relaxed line-clamp-2">
                                                {typeof log.details === 'string' ? log.details : JSON.stringify(log.details)}
                                            </span>
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className="text-[9px] px-1.5 py-0.5 rounded bg-[var(--muted)]/20 text-[var(--muted-foreground)] font-bold uppercase tracking-wider">
