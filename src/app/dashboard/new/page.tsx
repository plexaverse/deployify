    ...
    return (
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
            ...
            <div className="space-y-4">
                <Link
                    href="/dashboard"
                className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors mb-4"
                >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Git Connectivity</span>
                            <h1 className="text-[11px] md:text-xs font-bold tracking-tight">Import Repository</h1>
                        </div>
                    </div>
                </div>
            </div>
