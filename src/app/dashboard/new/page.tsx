    ...
    return (
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-8 space-y-10">
            ...
            <div className="space-y-4">
                <Link
                    href="/dashboard"
                className="inline-flex items-center gap-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors mb-4"
                >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Git Connectivity</span>
                            <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">Import Repository</h1>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div className="p-6 flex items-center gap-3 relative">
                                        ...
                                        <div className="relative z-10 flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                <h3 className="text-[11px] font-bold text-[var(--foreground)] group-hover:text-[var(--primary)] transition-colors truncate">
                                                    {repo.full_name.toUpperCase()}
                                                </h3>
                                                {repo.private && (
                                                    <Badge variant="warning" className="text-[9px] px-1.5 py-0.5 uppercase font-bold tracking-wider">
                                                        Private
                                                    </Badge>
                                                )}
                                            </div>
                                            <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] truncate mt-0.5">
                                                {repo.description || 'No description'}
                                            </p>
                                            <div className="flex items-center gap-4 mt-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                                                {repo.language && (
                                        ...
                                        <div className="relative z-10 flex items-center gap-3">
                                            <Button
                                                ...
                                                className="hidden sm:flex text-[9px] font-bold uppercase tracking-wider"
                                            >
                                                Import
                                            </Button>
