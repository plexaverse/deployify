            ...
            <div className="space-y-8">
                ...
                <Card className="overflow-hidden p-0">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label className="text-[10px] font-bold block mb-2">Project Name</Label>
                            <Input
                                type="text"
                                value={projectName}
                ...
                <Card className="overflow-hidden p-0">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label className="text-[10px] font-bold block mb-2">Build Command</Label>
                            <Input
                                type="text"
                                value={buildCommand}
                        ...
                        <div className="space-y-2">
                            <Label className="text-[10px] font-bold block mb-2">Output Directory</Label>
                            <Input
                                type="text"
                        ...
                        <div className="space-y-2">
                            <Label className="text-[10px] font-bold block mb-2">Install Command</Label>
                            <Input
                                type="text"
                    ...
                    <div className="space-y-4 p-4 bg-[var(--muted)]/5 rounded-lg border border-[var(--border)]">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-center gap-3 p-3 rounded-lg border border-[var(--border)] bg-[var(--card)]/50">
                                ...
                                />
                                <Label htmlFor="is-secret" className="text-[10px] font-bold cursor-pointer flex items-center gap-1.5">
                            ...
                            <div className="space-y-2 flex-1 max-w-xs">
                                <Label className="text-[10px] font-bold block mb-2">Target Environment</Label>
                                <SegmentedControl
                                    value={newEnvTarget}
