            ...
            <div className="space-y-4">
                <Link
                    ...
                    className={cn(
                        ...
                        "inline-flex items-center gap-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)] hover:text-[var(--foreground)] px-0 h-auto hover:bg-transparent transition-colors"
                    )}
                >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Project Import</span>
                            <h1 className="text-[9px] md:text-[11px] font-bold tracking-tight">Configure Project</h1>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <div className="flex flex-col items-end">
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Repository</span>
                            <span className="text-[11px] font-bold truncate max-w-[200px]">{repoFullName.toUpperCase()}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <Card className="overflow-hidden p-0">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold block mb-2">Project Name</Label>
                            <Input
                                type="text"
                                value={projectName}
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Build Pipeline</span>
                            <h2 className="text-[9px] md:text-[11px] font-bold">Build Settings</h2>
                        </div>
                    </div>
                    <Separator className="bg-[var(--border)]" />
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold block mb-2">Build Command</Label>
                            <Input
                                type="text"
                                value={buildCommand}
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold block mb-2">Output Directory</Label>
                            <Input
                                type="text"
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-bold block mb-2">Install Command</Label>
                            <Input
                                type="text"
                ...
                <Card className="overflow-hidden p-0">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">Infrastructure</span>
                            <h2 className="text-[9px] md:text-[11px] font-bold">Database Connectors</h2>
                        </div>
                    </div>
                    <Separator className="bg-[var(--border)]" />
                    ...
                    <div className="p-6 space-y-6">
                                ...
                                <div key={idx} className="flex items-center gap-2 p-3 rounded-lg bg-[var(--muted)]/10 border border-[var(--border)]">
                                    <div className="flex-1 grid grid-cols-3 gap-4 items-center">
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--primary)]">{config.name}</span>
                                            <span className="text-[9px] font-bold text-[var(--muted-foreground)] uppercase">{config.type.replace(/-/g, ' ')}</span>
                                        </div>
                                        <span className="font-mono text-[9px] font-bold uppercase tracking-wider text-[var(--foreground)]">
                                            {config.envKey}
                                        </span>
                        ...
                        <div className="p-4 bg-[var(--muted)]/5 rounded-lg border border-[var(--border)] space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label className="text-[9px] font-bold uppercase tracking-wider">Connector Name</Label>
                                    <Input
                                        placeholder="PRIMARY DB"
                                        id="new-storage-name"
                                        className="text-[9px] font-bold uppercase tracking-wider placeholder:text-[9px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-[9px] font-bold uppercase tracking-wider">Database Type</Label>
                                    <NativeSelect
                                        id="new-storage-type"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label className="text-[9px] font-bold uppercase tracking-wider">Connection String</Label>
                                    <Input
                                        type="password"
                                        placeholder="POSTGRESQL://USER:PASS@HOST:PORT/DB"
                                        id="new-storage-conn"
                                        className="text-[9px] font-bold uppercase tracking-wider font-mono placeholder:text-[9px] placeholder:font-bold placeholder:uppercase placeholder:tracking-wider"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-[9px] font-bold uppercase tracking-wider">Env Var Key</Label>
                                    <Input
                            ...
                            <div className="flex items-center justify-between gap-4 pt-2">
                                <div className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                    ...
                    <div className="space-y-4 p-4 bg-[var(--muted)]/5 rounded-lg border border-[var(--border)]">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-center gap-3 p-3 rounded-lg border border-[var(--border)] bg-[var(--card)]/50">
                                ...
                                />
                                <Label htmlFor="is-secret" className="text-[11px] font-bold cursor-pointer flex items-center gap-1.5">
                            ...
                            <div className="space-y-2 flex-1 max-w-xs">
                                <Label className="text-[11px] font-bold block mb-2">Target Environment</Label>
                                <SegmentedControl
                                    value={newEnvTarget}
                ...
                <div className="flex justify-end pt-4">
                    <MovingBorderButton
                        ...
                        className="text-[9px] font-bold uppercase tracking-wider shadow-[var(--primary-glow)]"
                    >
                        {isDeploying ? (
                            <>
