    ...
    return (
        <div className={cn(
            ...
            <motion.div
                ...
                className={cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold border relative",
                ...
                <div className="p-6 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label htmlFor="projectName" className="text-[10px] font-bold block mb-2">Project Name</label>
                            <Input
                                id="projectName"
                                type="text"
                                value={projectName}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold block mb-2">Framework Preset</label>
                            <NativeSelect
                                value={framework}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold block mb-2">Root Directory</label>
                            <Input
                                type="text"
                                value={rootDirectory}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold block mb-2">Region</label>
                            <NativeSelect
                                value={region}
                    ...
                    <div className="pt-4 border-t border-[var(--border)]">
                        <button
                            ...
                            className="flex items-center gap-2 text-[10px] font-bold text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors"
                        >
                            ...
                            {showAdvanced && (
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
                                        <div className="space-y-2">
                                            <label htmlFor="buildCommand" className="text-[10px] font-bold block mb-2">Build Command</label>
                                            <Input
                                                id="buildCommand"
                                                type="text"
                                                value={buildCommand}
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="installCommand" className="text-[10px] font-bold block mb-2">Install Command</label>
                                            <Input
                                                id="installCommand"
                                                type="text"
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="outputDirectory" className="text-[10px] font-bold block mb-2">Output Directory</label>
                                            <Input
                                                id="outputDirectory"
                                                type="text"
                    ...
                    <div className="space-y-4 p-4 bg-[var(--muted)]/5 rounded-lg border border-[var(--border)]">
                        ...
                        <div className="flex flex-col md:flex-row md:items-start gap-8 pt-4">
                            <div className="flex items-center gap-3 p-3 rounded-lg border border-[var(--border)] bg-[var(--card)]/50">
                                ...
                                />
                                <label htmlFor="isSecret" className="text-[10px] font-bold cursor-pointer flex items-center gap-1.5">
                            ...
                            <div className="flex-1 space-y-4">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-bold block mb-2">Target Environment Type</Label>
                                    <SegmentedControl
                                        options={[
                                ...
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-bold block mb-2">Scope</Label>
                                    <SegmentedControl
                                        options={[
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    <motion.div
                        ...
                        className="text-[10px] font-bold flex items-center gap-3"
                    >
                        {isReady ? (
                            <motion.div
                                initial={{ scale: 0 }}
